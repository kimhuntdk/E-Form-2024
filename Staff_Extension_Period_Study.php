						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<form action="javascipt:;" method="post" id="frm_add_extension_period_study" class="frm_add_extension_period_study">
                  ...
                  <span class="custom-control-label">แบบฟอร์ไม่ถูกต้อง</span> </label>
                          ...
                          <option value="5" <?php if($row[dean_admin] ==5) { echo "selected";}?>>รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ</option>
										...
										<div class="btn-list mt-4 text-left">
											...
											<input type="hidden" name="Save_Staff_extension_period_study" value="Save_Staff_extension_period_study">
		...
		$( "#btnSaveSign" ).click( function () { //ส่งค่าไป Update คำร้อง
			...
			if ( staff_grad_approve_disapprove === "1" ) {
				...
				if ( dean_admin === "0" ) {
					...
					$.post(
						"save_staff_extension_period_study.php",
						$( "#frm_add_extension_period_study" ).serializeArray(),
						function ( data ) {
							//alert(data);
							if ( data === "1" ) {
