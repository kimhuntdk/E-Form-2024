...
if ($_SESSION["SES_LEVEL"] != "advisor_ses" || $SES_USER == "") {
...
if ($_REQUEST['ddlstatus']) {
	$status_ = $_REQUEST['ddlstatus'];
}
//== ลงทะเบียนเพิ่ม
$sql = "SELECT * FROM request_doc LEFT JOIN request_registration_thesis_is ON request_doc.doc_id=request_registration_thesis_is.doc_id WHERE request_registration_thesis_is.advisor_chairman_status='$status_' AND request_registration_thesis_is.advisor_chairman=" . $SES_USER;
$result = $mysqli->query($sql);
//== ลาพักการเรียน
$sql_tl = "SELECT * FROM request_doc LEFT JOIN request_taking_leave ON request_doc.doc_id=request_taking_leave.doc_id WHERE request_taking_leave.advisor_chairman_status='$status_' AND request_taking_leave.advisor_chairman=" . $SES_USER;
$result_tl = $mysqli->query($sql_tl);
//== คืนสภาพนิสิต
$sql_rs = "SELECT * FROM request_doc LEFT JOIN request_retaining_student_status ON request_doc.doc_id=request_retaining_student_status.doc_id WHERE request_retaining_student_status.advisor_chairman_status='$status_' AND request_retaining_student_status.advisor_chairman=" . $SES_USER;
$result_rs = $mysqli->query($sql_rs);
//== ลงทะเบียนรักษาสภาพ
$sql_sr = "SELECT * FROM request_doc LEFT JOIN request_student_status_retention ON request_doc.doc_id=request_student_status_retention.doc_id WHERE request_student_status_retention.advisor_chairman_status='$status_' AND request_student_status_retention.advisor_chairman=" . $SES_USER;
$result_sr = $mysqli->query($sql_sr);
//== ชำระค่าธรรมเนียมการศึกษา 
$sql_fp = "SELECT * FROM request_doc LEFT JOIN request_fee_payment ON request_doc.doc_id=request_fee_payment.doc_id WHERE request_fee_payment.advisor_chairman_status='$status_' AND request_fee_payment.advisor_chairman=" . $SES_USER;
$result_fp = $mysqli->query($sql_fp);
//== คำร้องขอกลับเข้ารับราชการ 
$sql_rw = "SELECT * FROM request_doc LEFT JOIN request_return_work ON request_doc.doc_id=request_return_work.doc_id WHERE request_return_work.advisor_chairman_status='$status_' AND request_return_work.advisor_chairman=" . $SES_USER;
$result_rw = $mysqli->query($sql_rw);
//== ขอหนังสือรับรองการขยายเวลาศึกษาต่อ 
$sql_eps = "SELECT * FROM request_doc LEFT JOIN request_extension_period_study ON request_doc.doc_id=request_extension_period_study.doc_id WHERE request_extension_period_study.advisor_chairman_status='$status_' AND request_extension_period_study.advisor_chairman=" . $SES_USER;
$result_eps = $mysqli->query($sql_eps);
//== ขออนุมัติถอนการลงทะเบียนเรียนเพื่อลาพักการเรียน 
$sql_wrtl = "SELECT * FROM request_doc LEFT JOIN request_withdraw_registration_taking_leave ON request_doc.doc_id=request_withdraw_registration_taking_leave.doc_id WHERE request_withdraw_registration_taking_leave.advisor_chairman_status='$status_' AND request_withdraw_registration_taking_leave.advisor_chairman=" . $SES_USER;
$result_wrtl = $mysqli->query($sql_wrtl);
//== ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน
$sql_wtlr = "SELECT * FROM request_doc LEFT JOIN request_withdraw_taking_leave_registration ON request_doc.doc_id=request_withdraw_taking_leave_registration.doc_id WHERE request_withdraw_taking_leave_registration.advisor_chairman_status='$status_' AND request_withdraw_taking_leave_registration.advisor_chairman=" . $SES_USER;
$result_wtlr = $mysqli->query($sql_wtlr);
//== ขอบันทึกข้อความ
$sql_ds = "SELECT * FROM request_document_student LEFT JOIN request_doc ON request_document_student.doc_id=request_doc.doc_id WHERE request_document_student.advisor_chairman_status='$status_' AND request_document_student.advisor_chairman=" . $SES_USER;
$result_ds = $mysqli->query($sql_ds);
//== ขอหนังสือเปลี่ยนแปลงแผนการเรียน อาจารย์ที่ปรึกษา
$sql_csp = "SELECT * FROM request_doc LEFT JOIN request_change_study_program ON request_doc.doc_id=request_change_study_program.doc_id WHERE request_change_study_program.advisor_chairman_status = '$status_' AND request_change_study_program.advisor_chairman=" . $SES_USER;
$result_csp = $mysqli->query($sql_csp);
//== ขอหนังสือเปลี่ยนแปลงแผนการเรียน อาจารย์ประธานหลักสูตร
$sql_csp_ch = "SELECT * FROM request_doc LEFT JOIN request_change_study_program ON request_doc.doc_id=request_change_study_program.doc_id WHERE request_change_study_program.advisor_chairman_status=1 AND request_change_study_program.chairman_board_status='$status_' AND request_change_study_program.chairman_board=" . $SES_USER;
$result_csp_ch = $mysqli->query($sql_csp_ch);
//== ขอหนังสือเปลี่ยนสาขา อาจารย์ที่ปรึกษา
$sql_cfs = "SELECT * FROM request_doc LEFT JOIN request_change_field_study ON request_doc.doc_id=request_change_field_study.doc_id WHERE request_change_field_study.advisor_chairman_status = '$status_' AND request_change_field_study.advisor_chairman=" . $SES_USER;
$result_cfs = $mysqli->query($sql_cfs);
//== ขอหนังสือเปลี่ยนสาขา อาจารย์ประธานหลักสูตร
$sql_cfs_ch = "SELECT * FROM request_doc LEFT JOIN request_change_field_study ON request_doc.doc_id=request_change_field_study.doc_id WHERE request_change_field_study.advisor_chairman_status=1  AND request_change_field_study.chairman_board_status='$status_' AND request_change_field_study.chairman_board=" . $SES_USER;
$result_cfs_ch = $mysqli->query($sql_cfs_ch);
//== ขอหนังสือแต่งตั้งชื่อเรื่อง
$sql_aa = "SELECT * FROM request_doc LEFT JOIN request_appointment_advisor ON request_doc.doc_id=request_appointment_advisor.doc_id WHERE request_appointment_advisor.advisor_status='$status_' AND request_appointment_advisor.advisor_code=" . $SES_USER;
$result_aa = $mysqli->query($sql_aa);
//== ขอหนังสือแต่งตั้งคณะกรรมการสอบโครงร่าง
$sql_pe = "SELECT * FROM request_doc LEFT JOIN request_proposal_examination ON request_doc.doc_id=request_proposal_examination.doc_id WHERE request_proposal_examination.advisor_status='$status_' AND  request_proposal_examination.advisor_code=" . $SES_USER;
$result_pe = $mysqli->query($sql_pe);
//== ขอหนังสือแต่งตั้งคณะกรรมการสอบวิทยานิพนธ์
$sql_te = "SELECT * FROM request_doc LEFT JOIN request_thesis_examination ON request_doc.doc_id=request_thesis_examination.doc_id WHERE request_thesis_examination.advisor_status='$status_' AND  request_thesis_examination.advisor_code=" . $SES_USER;
									...
									<table class="table table-hover table-outline table-vcenter text-nowrap card-table">
										...
										<tbody>
											...
											foreach ($result as $row) {
												...
												if (1 == 1) { // แสดงภายใน 7 วัน นับตั้งแต่วันที่ส่ง 
											?>
													<tr>
											...
											?>
													<tr>
														...
														<td class="text-center">
															<div class="item-action dropdown">
																<a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
																<div class="dropdown-menu dropdown-menu-right"> <a href="Advisor_Retaining_Student_Status.php?doc_id=<?= base64_encode($row_rs['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a>
																	<!-- <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a>-->
																</div>
														</td>
														<td>
															<?php
															$advisor_chairman_status = $row_rs['advisor_chairman_status'];
															if ($advisor_chairman_status == 0) {
																echo "<span class='text text-warning'>In Progress</span>";
															} else if ($advisor_chairman_status == 1) {
																echo "<span class='text text-success'>Approved</span>";
														...
														<td>
															...
															if ($doc_type1 == 3) {
																...
																echo "คำร้องขอคืนสภาพนิสิต/Request Form for Retainting Student Status";
															}
											...
											foreach ($result_wrtl as $row_wrtl) {
												$date = $row_wrtl["std_date_signature"]; //วันที่ส่ง
												$date_ =  date("Y-m-d", strtotime("+6 day", strtotime($date))); // เพิ่มขึ้นทีละ 1 วัน
												$date_curent = date("Y-m-d");
												$stats = $row_wrtl["advisor_chairman_status"]; // สถานการอนุมัติของอาจารย์ 
											?>
											...
											foreach ($result_wtlr as $row_wtlr) {
												$date = $row_wtlr["std_date_signature"]; //วันที่ส่ง
												$date_ =  date("Y-m-d", strtotime("+6 day", strtotime($date))); // เพิ่มขึ้นทีละ 1 วัน
												$date_curent = date("Y-m-d");
												$stats = $row_wtlr["advisor_chairman_status"]; // สถานการอนุมัติของอาจารย์
											...
											foreach ($result_cfs as $row_cfs) {
												$date = $row_cfs["std_date_signature"]; //วันที่ส่ง
												$date_ =  date("Y-m-d", strtotime("+6 day", strtotime($date))); // เพิ่มขึ้นทีละ 1 วัน
												$date_curent = date("Y-m-d");
												$stats = $row_cfs["advisor_chairman_status"]; // สถานการอนุมัติของอาจารย์
											...
											foreach ($result_csp_ch as $row_csp_ch) {
												$date = $row_csp_ch["std_date_signature"]; //วันที่ส่ง
												$date_ =  date("Y-m-d", strtotime("+6 day", strtotime($date))); // เพิ่มขึ้นทีละ 1 วัน
												$date_curent = date("Y-m-d");
												$stats = $row_csp_ch["advisor_chairman_status"]; // สถานการอนุมัติของอาจารย์
											...
											foreach ($result_cfs_ch as $row_cfs_ch) {
												$date = $row_cfs_ch["std_date_signature"]; //วันที่ส่ง
												$date_ =  date("Y-m-d", strtotime("+6 day", strtotime($date))); // เพิ่มขึ้นทีละ 1 วัน
												$date_curent = date("Y-m-d");
												$stats = $row_cfs_ch["advisor_chairman_status"]; // สถานการอนุมัติของอาจารย์
