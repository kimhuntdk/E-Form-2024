              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">ขออนุมัติถอนการลงทะเบียนเรียนเพื่อลาพักการเรียน / Request Form for Withdraw for Registration to Leave of Absence</h3>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        <div class="custom-controls-stacked">
                          <label class="custom-control custom-checkbox">
                            <input type="checkbox" id="finished_a" class="custom-control-input" name="finished_a" value="1" <?php if($row['finished_assignment'] !='') { echo "checked"; }?>  >
                            <span class="custom-control-label">งานที่ทำแล้วเสร็จ/ The finished assignment: </span>
                            <input type="text" class="form-control" id="finished_assignment" placeholder="" disabled value="<?php echo $row['finished_assignment']; ?>">
                          </label>
                          <label class="custom-control custom-checkbox">
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_withdraw_tegistration_taking_leave.php", {
						img_data: img_data,
