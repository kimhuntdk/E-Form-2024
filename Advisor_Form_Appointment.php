...
//=========แสดงข้อมูลนิสิตที่ยื่นเอกสาร======================
 $sql = "SELECT * FROM request_doc LEFT JOIN request_appointment_advisor ON request_doc.doc_id=request_appointment_advisor.doc_id WHERE request_doc.doc_id=" . $doc_id;
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_appointment.php", {
						img_data: img_data,
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องตั้งตั้งชื่อเรื่องวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ</h3>
								</div>
								<div class="card-body">
									...
									<form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12">มีความประสงค์แต่งตั้งชื่อเรื่อง</label>
											</div>
										</div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select" id="academic" name="academic" disabled>
                          ...
                          <option value="2554" <?php if($row[ 'academic']=="2554" ) { echo "selected"; } ?>>2554</option>
											...
											<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-2">ชื่อเรื่องภาษาไทย<span class="form-required">*</span></label>
												<div class="col-sm-10"> 
												<!--	<input type="text" class="form-control" id="title_th" name="title_th" >-->
												   <textarea class="form-control" id="title_th" name="title_th" disabled><?=$row['title_th'];?></textarea>
												</div>
											</div>
										</div>
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-2">ชื่อเรื่องภาษาอังกฤษ<span class="form-required">*</span></label>
												<div class="col-sm-10"> 
													<!--<input type="text" class="form-control" id="title_en" name="title_en" >-->
                                                    <textarea class="form-control" id="title_en" name="title_en" disabled><?=$row['title_en'];?></textarea>
