	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				var major_old = $( "#major_old" ).val();
				var major_new = $( "#major_new" ).val();
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_Change_Field_Study.php", {
							img_data: img_data,
							major_old: major_old,
							major_new: major_new,
							semester: semester,
			...
			<div class="my-3 my-md-5">
                ...
                <span class="custom-control-label">ภาคการศึกษาพิเศษ/ 3<sup>nd</sup> semester</span> </label>
								...
								<!--		<div class="form-group">
										...
										<div class="form-group">
                                        	<div class="col-sm-12">
											<input type="text" class="form-control" id="major_old" name="major_old">
                                            </div>
										</div>
                                        	<div class="row align-items-center">
										...
										<div class="form-group">
                                        	<div class="col-sm-12">
											<input type="text" class="form-control" id="major_new" name="major_new">
                                            </div>
										</div>

										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">ประธานบริหารหลักสูตร (สาขาวิชาเดิม) (Chairman of the board of program) (Old major) <span class="form-required">*</span></label>
												<div class="col-sm-9">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">ความเห็นประธานหลักสูตร (สาขาวิชาใหม่)
(Chairman of the board of program) (New major)
