	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				var choose = $( "input[type=radio][name=choose]:checked" ).val();
				...
				if ( because == 0 ) {
					...
					if ( choose === undefined ) {
					alert( "กรุณาเลือกมีความประสงค์จะปรับเปลี่ยนสภาพนิสิต/I would like to change my status" );
					$( "#choose" ).focus();
					return false;
				}
				/*alert(finished_a);
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_ChangingStudentStatus.php", {
							img_data: img_data,
							semester: semester,
							academic: academic,
							because: because,
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องขอปรับเปลี่ยนสภาพนิสิต (ระดับบัณฑิตศึกษา) Request Form for Changing Student Status (Graduate Student)</h3>
								</div>
								<div class="card-body">
                ...
                <span class="custom-control-label">ภาคการศึกษาพิเศษ/ 3<sup>nd</sup> semester</span> </label>
										...
										<div class="form-group">
											...
											<div class="custom-controls-stacked">
												...
												<label class="custom-control custom-radio custom-control-inline">
              <input type="radio" class="custom-control-input"  name="choose" id="choose" value="1" >
               <span class="custom-control-label"> มีความประสงค์จะปรับเปลี่ยนสภาพนิสิต  จาก  ระบบนอกเวลาราชการ  เป็น  ระบบในเวลาราชการ 
               I would like to change my status from weekend student to weekday student</span>
				</label>
                <label class="custom-control custom-radio custom-control-inline">
				  <input type="radio" class="custom-control-input"  name="choose" id="choose" value="2" >
               <span class="custom-control-label"> มีความประสงค์จะปรับเปลี่ยนสภาพนิสิต  จาก  ระบบในเวลาราชการ เป็น  ระบบนอกเวลา 
               I would like to change my status from weekday student to weekend student</span>
				</label>
