...
//== คำร้องขอลงทะเบียนรักษาสภาพ (กรณีพิเศษ)
  $sql_srfs = "SELECT * FROM request_doc LEFT JOIN request_status_retention ON request_doc.doc_id=request_status_retention.doc_id WHERE request_doc.doc_std_id='$SES_STDCODE' AND request_doc.doc_type=13 order by request_doc.doc_id desc ";
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center"><?php
													...
													echo $i;
													//ตรวจสอบรหัสประคณะที่ เจ้าหน้าที่ login เข้ามา
													?>
...
-->
                      ...
                      <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div></td>
								...
								if($registration_division_status==0){ ?>
											...
											<td>
												<div>
													<?php echo $row_nameSrfs['std_fname_th'];?>&nbsp;
													<?php echo $row_nameSrfs['std_lname_th'];?>
											    </div>
                    ...
                    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div></td>
								...
								if($dean_admin_approve_disapprove==0){ ?>
												...
												<td>
													<div>
															<?php echo $row_namedsg['std_fname_th'];?>&nbsp;
													<?php echo $row_namedsg['std_lname_th'];?>
													</div>
													<div class="small text-muted"> Send:
                    ...
                    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
												...
												<td>
													<?php                       $advisor_chairman_status = $row_csp['advisor_chairman_status'];
								...
								if($advisor_chairman_status==0){ ?>
												...
												<td>
                                                <?php                       $chairman_board_status = $row_csp['chairman_board_status'];
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
												...
												<td>
													<?php                       $advisor_chairman_status = $row_aa['advisor_status'];
			             
                           	 	
								if($advisor_chairman_status==0){ ?>
													<button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if($row_aa['advisor_node']==" "){echo "- ";}else{echo $row_csp['advisor_node'];}?>"> In Progress </button>
													<?php	}else if($advisor_chairman_status==1) { ?>
													<button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if($row_aa['advisor_node']==" "){echo "- ";}else{echo $row_csp['advisor_node'];}?>"> Approved </button>
													<?php	}else if($advisor_chairman_status==2) { ?>
													<button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if($row_aa['advisor_node']==" "){echo "- ";}else{echo $row_csp['advisor_node'];}?>"> Rejected </button>
													<?php	}else if($advisor_chairman_status==3) { ?>
													<button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if($row_aa['advisor_node']==" "){echo "- ";}else{echo $row_csp['advisor_node'];}?>"> Rejected </button>
													<?php
													}
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
												...
												<td>
													<?php                       $advisor_chairman_status = $row_pe['advisor_status'];
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
												...
												<td>
													<?php                       $advisor_chairman_status = $row_te['advisor_status'];
