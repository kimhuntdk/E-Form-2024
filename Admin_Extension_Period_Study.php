              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">ขอหนังสือรับรองการขยายเวลาศึกษาต่อ Request Form for Extension Period of Study (Graduate Student)</h3>
                  </div>
                  <div class="card-body">
...
$(document).ready(function(e){
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
						...
						$.post( "digital-e-signature/update_admin_extension_period_study.php", {
