...
<div class="col-md-8">
    <label>Staff Status :</label>
                        <select class="form-control" name="staff_grad_approve_disapprove" id="staff_grad_approve_disapprove" required>
                          <option value="0" <?php if($staff_grad_approve_disapprove==0){ echo "selected"; } ?> >In progress</option>
                          <option value="1" <?php if($staff_grad_approve_disapprove==1){ echo "selected"; } ?>>Approved</option>
                          <option value="2" <?php if($staff_grad_approve_disapprove==2){ echo "selected"; } ?>>Disapproved</option>
                       </select>
</div>
...
<div class="col-md-8">
    <label>REGISTRATION Status :</label>
                        <select class="form-control" name="registration_division_status" id="registration_division_status" required>
                          ...
                          <option value="2" <?php if($registration_division_status==99){ echo "selected"; } ?>>Disapproved</option>
                       </select>
</div>
<div class="col-md-8">
                <label>ข้อความกองทะเบียน :</label>    
                <textarea class="form-control" name="node"><?php echo  $registration_division_node;?></textarea>
</div>
<hr class="mb-4">
