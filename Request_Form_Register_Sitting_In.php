						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องขอลงทะเบียนเรียนร่วม (ระดับบัณฑิตศึกษา)   (Graduate Request Form to Register for Sitting In  Student)</h3>
								</div>
								<div class="card-body">
									...
									<form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12"><strong>มีความประสงค์ขอลงทะเบียนเรียนร่วมรายวิชาในระบบ / I would like to register for sitting in</strong>
<span class="form-required">*</span> </label>
                ...
                <span class="custom-control-label">ในเวลาราชการ(Weekday)   </span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="semester" id="semester" value="2">
                <span class="custom-control-label">นอกเวลาราชการ(Weekend)   </span> </label>
                                        			...
                                        			<div class="form-group">
											<label class="form-label"> ภาคการศึกษาที่ Semester <span class="form-required">*</span> </label>
											<select class="form-control" id="academic" name="academic">
												<option value="0">เลือก ภาคการศึกษาที่ Semester</option>
												<option value="1">ภาคต้น/ 1 <sup>st</sup> semester</option>
												<option value="2">ภาคปลาย/ 2 <sup>st</sup> semester</option>
												<option value="3">ภาคการศึกษาพิเศษ/3 <sup>st</sup> semester</option>
								...
								<!--		<div class="form-group">
                                       ...
                                       <strong> ดังรายวิชาต่อไปนี้ (as follows)</strong>
										...
										<div class="form-group col-sm-1">ลำดับ</div>
                                         ...
                                         <div class="form-group col-sm-3">นก./ชม. Credits/Hours</div>
                                         <div class="form-group col-sm-3">อาจารย์ผู้สอน (Lecturer(s))</div>
                                       </div>
                                       </div>
                                           <div class="form-group">
                                        <div class="row align-items-center">
                                         ...
                                         <div class="form-group col-sm-3"><input type="text" name="Credits[]" id="Credits" class="form-control"></div>
                                         <div class="form-group col-sm-3"><input type="text" name="Lecturer[]" id="Lecturer" class="form-control"></div>
                                       </div>
                                       </div>
                                        <div class="form-group">
                                        <div class="row align-items-center">
							            <div class="form-group col-sm-1">2.</div>
                                         <div class="form-group col-sm-2"><input type="text" name="Code[]" class="form-control"></div>
                                         <div class="form-group col-sm-3"><input type="text" name="Title[]" class="form-control"></div>
                                         <div class="form-group col-sm-3"><input type="text" name="Credits[]" class="form-control"></div>
                                         <div class="form-group col-sm-3"><input type="text" name="Lecturer[]" class="form-control"></div>
                                       </div>
                                       </div>
                                          <div class="form-group">
                                        <div class="row align-items-center">
										...
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">อาจารย์ที่ปรึกษา/ประธานควบคุมวิทยานิพนธ์ (Advisor/Chairman of Thesis)<span class="form-required">*</span></label>
												<div class="col-sm-9">
 ...
 (Chairman of the Curriculum Administration)
 <span class="form-required">*</span></label>
												<div class="col-sm-9">
													<select id="advisor" name="advisor" class="custom-select">
														<?php
