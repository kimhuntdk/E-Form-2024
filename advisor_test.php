										...
										<tbody>
											...
											foreach ( $result as $row ) {
												...
												<td class="text-center">
													<div class="item-action dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right"> <a href="Advisor_Registration_Thesis_Test.php?doc_id=<?=base64_encode($row[doc_id]);?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a>
											...
											<tr>
												...
												<td class="text-center">
													<div class="item-action dropdown">
														<a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a href="Advisor_Taking_Leave_Test.php?doc_id=<?=base64_encode($row_tl[doc_id]);?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a>
															<!-- <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a>-->
														</div>
												</td>
												<td>
