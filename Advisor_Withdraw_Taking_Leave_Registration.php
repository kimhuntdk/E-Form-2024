...
$sql = "SELECT * FROM request_doc LEFT JOIN request_withdraw_taking_leave_registration ON request_doc.doc_id=request_withdraw_taking_leave_registration.doc_id WHERE request_doc.doc_id=" . $doc_id;
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน  / Request Form for Withdrawal of Leave of Absence to Registration</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">มีความประสงค์ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน  / Request Form for Withdrawal of Leave of Absence to Registration"<span class="form-required">*</span> </label>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="custom-controls-stacked">
                          <label class="custom-control custom-checkbox">
                            <input type="checkbox" id="finished_a" class="custom-control-input" name="finished_a" value="1" <?php if($row['finished_assigment'] !='') { echo "checked"; }?>  >
                            <span class="custom-control-label">งานที่ทำแล้วเสร็จ/ The finished assignment: </span>
                            <input type="text" class="form-control" id="finished_assignment" placeholder="" disabled value="<?php echo $row['finished_assigment']; ?>">
                          </label>
                          <label class="custom-control custom-checkbox">
                            <input type="checkbox" id="unfinished_a" class="custom-control-input" name="unfinished_a" value="1" <?php if($row['unfinished_assignment'] !='') { echo "checked"; }?>>
                            <span class="custom-control-label">งานที่กำลังทำ / The unfinished assignment: </span>
                            <input type="text" class="form-control" placeholder="" id="unfinished_assignment"  disabled value="<?php echo $row['unfinished_assignment']; ?>">
                          </label>
                          <label class="custom-control custom-checkbox">
                            <input type="checkbox" id="unstarting_a" class="custom-control-input" name="unstarting_a" value="1" <?php if($row['unstarting_assignment'] !='') { echo "checked"; }?>  >
                            <span class="custom-control-label">งานที่ยังไม่ทำ/ The unstarting assignment: </span>
                            <input type="text" class="form-control" placeholder="" id="unstarting_assignment" disabled value="<?php echo $row['unstarting_assignment']; ?>">
                          </label>
                        </div>
                      </div>
                      <div class="form-group">
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_withdraw_taking_leave_registration.php", {
						img_data: img_data,
