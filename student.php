...
//== คืนสภาพนิสิต
$sql_rs = "SELECT * FROM request_retaining_student_status LEFT JOIN request_doc ON request_retaining_student_status.doc_id=request_doc.doc_id Where request_doc.doc_std_id='$SES_STDCODE'  order by request_doc.doc_id desc ";
$result_rs = $mysqli->query($sql_rs);
$num_result_rs = $result_rs->num_rows;
...
$sql_srfs = "SELECT * FROM request_doc LEFT JOIN request_status_retention ON request_doc.doc_id=request_status_retention.doc_id WHERE request_doc.doc_std_id='$SES_STDCODE' AND request_doc.doc_type=2 order by request_doc.doc_id desc ";
                  ...
                  <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                    ...
                    <tbody>
                      ...
                      foreach ($result as $row) {
                        ...
                        if ($date_curent <= $date_ && $stats == 0) { // แสดงภายใน 7 วัน นับตั้งแต่วันที่ส่ง 
                      ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <div class="item-action dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right"> <a href="Student_Registration_Thesis&doc_id=<?= base64_encode($row['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td>
                              <div> <?php echo $row_name['std_fname_th']; ?>&nbsp; <?php echo $row_name['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row['doc_date']; ?> </div>
                            </td>
                            <td><?php
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Registration_Thesis&doc_id=<?= base64_encode($row['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                                $registration_thesis_status = $row['advisor_chairman_status'];
                                if ($registration_thesis_status == 0) {
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_tl['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_tl['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                      ...
                      ?>
                          <tr>
                            <td class="text-center"><?php
                                                    $sql_name2 = "Select std_id_std,std_fname_th,std_lname_th FROM request_student WHERE std_id_std = '$row_rs[doc_std_id]' ";
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_rs['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                                $registration_thesis_status = $row_rs['advisor_chairman_status'];
                                if ($registration_thesis_status == 0) {
                                ?>
                            ...
                            <td><?php $staff_grad_approve_disapprove = $row_rs['staff_grad_approve_disapprove'];
                                if ($registration_thesis_status == 1) {
                            ...
                            <td><?php $dean_admin_approve_disapprove = $row_rs['dean_admin_approve_disapprove'];
                                if ($staff_grad_approve_disapprove == 1) {
                            ...
                            <td><?php $registration_division_status = $row_rs['registration_division_status'];
                                if ($dean_admin_approve_disapprove == 1) {
                            ...
                            <td>
                              <div> <?php echo $row_name2['std_fname_th']; ?>&nbsp; <?php echo $row_name2['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_rs['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right"> 
                                  <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_tl['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> 
                                  <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td><?php $registration_division_status = $row_sr['registration_division_status'];
                                if ($dean_admin_approve_disapprove == 1) {
                                  ...
                                  if ($registration_division_status == 0) { ?>
                                  <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_sr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_sr['registration_division_node'];
                                                                                                                                                                } ?>"> In Progress </button>
                                <?php  } else if ($registration_division_status == 1) { ?>
                                  <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_sr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_sr['registration_division_node'];
                                                                                                                                                                } ?>"> Approved </button>
                                <?php  } else if ($registration_division_status == 9) { ?>
                                  <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_sr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_sr['registration_division_node'];
                                                                                                                                                                } ?>"> Rejected </button>
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_sr['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_fp['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_rw['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_rw['doc_date']; ?> </div>
                            </td>
                            <td><?php
                                $doc_type1 = $row_fp['doc_type'];
                                if ($doc_type1 == 3) {
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_eps['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_eps['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_wrtl['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_wrtl['doc_date']; ?> </div>
                            </td>
                            <td><?php
...
-->
                            <td class="text-center">
                              <div class="item-action dropdown">
                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                                <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Taking_Leave&doc_id=<?= base64_encode($row_wtlr['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                            </td>
                            <td><?php
                                $registration_thesis_status = $row_wtlr['advisor_chairman_status'];
                                if ($registration_thesis_status == 0) {
                                ?>
                                <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['advisor_chairman_node'] == " ") {
                                                                                                                                                                echo "- ";
                                                                                                                                                              } else {
                                                                                                                                                                echo $row_wtlr['advisor_chairman_node'];
                                                                                                                                                              } ?>"> In Progress </button>
                              <?php  } else if ($registration_thesis_status == 1) { ?>
                                <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['advisor_chairman_node'] == " ") {
                                                                                                                                                                echo "- ";
                                                                                                                                                              } else {
                                                                                                                                                                echo $row_wtlr['advisor_chairman_node'];
                                                                                                                                                              } ?>"> Approved </button>
                              <?php  } else if ($registration_thesis_status == 2) { ?>
                                <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['advisor_chairman_node'] == " ") {
                                                                                                                                                                echo "- ";
                                                                                                                                                              } else {
                                                                                                                                                                echo $row_wtlr['advisor_chairman_node'];
                                                                                                                                                              } ?>"> Rejected </button>
                            ...
                            <td><?php $staff_grad_approve_disapprove = $row_wtlr['staff_grad_approve_disapprove'];
                                if ($registration_thesis_status == 1) {
                                  ...
                                  if ($staff_grad_approve_disapprove == 0) { ?>
                                  <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['staff_grad_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['staff_grad_node'];
                                                                                                                                                                } ?>"> In Progress </button>
                                <?php  } else if ($staff_grad_approve_disapprove == 1) { ?>
                                  <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['staff_grad_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['staff_grad_node'];
                                                                                                                                                                } ?>"> Approved </button>
                                <?php  } else if ($staff_grad_approve_disapprove == 2) { ?>
                                  <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['staff_grad_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['staff_grad_node'];
                                                                                                                                                                } ?>"> Rejected </button>
                            ...
                            <td><?php $dean_admin_approve_disapprove = $row_wtlr['dean_admin_approve_disapprove'];
                                if ($staff_grad_approve_disapprove == 1) {
                                  ...
                                  if ($dean_admin_approve_disapprove == 0) { ?>
                                  <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['dean_admin_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['dean_admin_node'];
                                                                                                                                                                } ?>"> In Progress </button>
                                <?php  } else if ($dean_admin_approve_disapprove == 1) { ?>
                                  <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['dean_admin_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['dean_admin_node'];
                                                                                                                                                                } ?>"> Approved </button>
                                <?php  } else if ($dean_admin_approve_disapprove == 2) { ?>
                                  <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['dean_admin_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['dean_admin_node'];
                                                                                                                                                                } ?>"> Rejected </button>
                            ...
                            <td><?php $registration_division_status = $row_wtlr['registration_division_status'];
                                if ($dean_admin_approve_disapprove == 1) {
                                  ...
                                  if ($registration_division_status == 0) { ?>
                                  <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['registration_division_node'];
                                                                                                                                                                } ?>"> In Progress </button>
                                <?php  } else if ($registration_division_status == 1) { ?>
                                  <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['registration_division_node'];
                                                                                                                                                                } ?>"> Approved </button>
                                <?php  } else if ($registration_division_status == 9) { ?>
                                  <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_wtlr['registration_division_node'] == " ") {
                                                                                                                                                                  echo "- ";
                                                                                                                                                                } else {
                                                                                                                                                                  echo $row_wtlr['registration_division_node'];
                                                                                                                                                                } ?>"> Rejected </button>
                            ...
                            <td>
                              <div> <?php echo $row_name1['std_fname_th']; ?>&nbsp; <?php echo $row_name1['std_lname_th']; ?> </div>
                              <div class="small text-muted"> Send: <?php echo $row_wtlr['doc_date']; ?> </div>
                            </td>
                            <td><?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="item-action dropdown">
                              <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                              <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                          </td>
                          ...
                          <td>
                            <div> <?php echo $row_nameSrfs['std_fname_th']; ?>&nbsp; <?php echo $row_nameSrfs['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_srfs['doc_date']; ?> </div>
                          </td>
                          <td><?php
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <div> <?php echo $row_nameds['std_fname_th']; ?>&nbsp; <?php echo $row_nameds['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_ds['doc_date']; ?> </div>
                          </td>
                          <td><?php
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <div> <?php echo $row_namedsg['std_fname_th']; ?>&nbsp; <?php echo $row_namedsg['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_dsg['doc_date']; ?> </div>
                          </td>
                          <td><?php
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <div> <?php echo $row_name_csp['std_fname_th']; ?>&nbsp; <?php echo $row_name_csp['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_csp['doc_date']; ?> </div>
                          </td>
                          <td><?php
...
-->
                          <td class="text-center">
                            <div class="item-action dropdown">
                              <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
                              <div class="dropdown-menu dropdown-menu-right"> <a href="?menu=Student_Registration_Thesis&doc_id=<?= base64_encode($row_cfs['doc_id']); ?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a> </div>
                          </td>
                          <td><?php
                          ...
                          <td>
                            <div> <?php echo $row_cfs_name['std_fname_th']; ?>&nbsp; <?php echo $row_cfs_name['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_cfs['doc_date']; ?> </div>
                          </td>
                          <td><?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php $advisor_chairman_status = $row_aa['advisor_status'];
                              ...
                              if ($advisor_chairman_status == 0) { ?>
                              <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_aa['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_cfs['advisor_node'];
                                                                                                                                                            } ?>"> In Progress </button>
                            <?php  } else if ($advisor_chairman_status == 1) { ?>
                              <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_aa['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_cfs['advisor_node'];
                                                                                                                                                            } ?>"> Approved </button>
                            <?php  } else if ($advisor_chairman_status == 2) { ?>
                              <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_aa['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_cfs['advisor_node'];
                                                                                                                                                            } ?>"> Rejected </button>
                          ...
                          <td>
                            <div> <?php echo $row_name_aa['std_fname_th']; ?>&nbsp; <?php echo $row_name_aa['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_aa['doc_date']; ?> </div>
                          </td>
                          <td><?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php $advisor_chairman_status = $row_pe['advisor_status'];
                              ...
                              if ($advisor_chairman_status == 0) { ?>
                              <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_pe['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_pe['advisor_node'];
                                                                                                                                                            } ?>"> In Progress </button>
                            <?php  } else if ($advisor_chairman_status == 1) { ?>
                              <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_pe['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_pe['advisor_node'];
                                                                                                                                                            } ?>"> Approved </button>
                            <?php  } else if ($advisor_chairman_status == 2) { ?>
                              <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_pe['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_pe['advisor_node'];
                                                                                                                                                            } ?>"> Rejected </button>
                          ...
                          <td>
                            <div> <?php echo $row_name_pe['std_fname_th']; ?>&nbsp; <?php echo $row_name_pe['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_pe['doc_date']; ?> </div>
                          </td>
                          <td><?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php $advisor_chairman_status = $row_te['advisor_status'];
                              ...
                              if ($advisor_chairman_status == 0) { ?>
                              <button type="button" class="btn btn-warning" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_te['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_te['advisor_node'];
                                                                                                                                                            } ?>"> In Progress </button>
                            <?php  } else if ($advisor_chairman_status == 1) { ?>
                              <button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_te['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_te['advisor_node'];
                                                                                                                                                            } ?>"> Approved </button>
                            <?php  } else if ($advisor_chairman_status == 2) { ?>
                              <button type="button" class="btn btn-danger" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php if ($row_te['advisor_node'] == " ") {
                                                                                                                                                              echo "- ";
                                                                                                                                                            } else {
                                                                                                                                                              echo $row_te['advisor_node'];
                                                                                                                                                            } ?>"> Rejected </button>
                          ...
                          <td>
                            <div> <?php echo $row_name_te['std_fname_th']; ?>&nbsp; <?php echo $row_name_te['std_lname_th']; ?> </div>
                            <div class="small text-muted"> Send: <?php echo $row_te['doc_date']; ?> </div>
                          </td>
                          <td><?php
    ...
    <footer class="footer medium-text-center text-center ">
      <div class="absolute-footer">
        <div class="container ">
          <div class="footer-secondary pull-left">
            <div class="menu-main1">
              <tr class="menu-item "><a href="index.php" aria-current="page"><u>Home</u></a></tr>
              <tr class="menu-item "><a href="https://grad.msu.ac.th/th/" target="_blank"><u>contact</u></a></tr>
              <tr class="menu-item "><a href="student.php"><u>form</u></a></tr>
            </div>
      ...
      <div class="copyright-footer"> Copyright © 2018 บัณฑิตวิทยาลัย มหาวิทยาลัยมหาสารคาม </div>
