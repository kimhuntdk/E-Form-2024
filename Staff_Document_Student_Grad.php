...
//=========แสดงข้อมูลนิสิตที่ยื่นเอกสาร======================
 $sql = "SELECT * FROM request_doc LEFT JOIN request_document_student_grad ON request_doc.doc_id=request_document_student_grad.doc_id WHERE request_doc.doc_id=" . $doc_id;
		...
		$( "#btnSaveSign" ).click( function () { //ส่งค่าไป Update คำร้อง
			...
			if ( staff_grad_approve_disapprove === "1" ) {
				...
				if ( dean_admin === "0" ) {
					...
					$.post(
						"save_document_student_grad.php",
