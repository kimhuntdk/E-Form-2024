                    ...
                    <form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      <div class="form-group">
                        <div class="row align-items-center">
                         <label class="col-sm-12"><strong>มีความประสงค์ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน/ Would like cancel to  Withdrawal of Leave  of Absence  to  Registratoin in</strong> <span class="form-required">*</span> </label>
                        </div>
                      </div>
...
$(document).ready(function(e){
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
						...
						$.post( "digital-e-signature/update_admin_withdraw_taking_leave_registration.php", {
