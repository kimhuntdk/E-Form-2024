	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			if(problem_bank_1 === undefined && capital_form_chk2 === undefined){
        		alert("lease select either case.");
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Memorandum (payment/document/late registration) </h3>
                  </div>
                  <div class="card-body">
                    ...
                    <form action="javascipt:;" method="post" id="frm_add_memorandum" class="frm_add_memorandum" name="frm_add_memorandum">
                     ...
                     <div class="form-group">As I, (Mr./Mrs./Miss)
<div class="form-group col-sm-9">
                      
										   <div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="titlename" id="titlename" value="Mr" >
                <span class="custom-control-label">Mr.</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="titlename" id="titlename" value="Mrs">
                <span class="custom-control-label">Mrs.</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="titlename" id="titlename" value="Miss">
                <span class="custom-control-label">Miss.</span> </label>
                       ...
                       <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-4">Name-Surname<span class="form-required">*</span></label>
                          <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-4">has passed and accepted to study in the major of <span class="form-required">*</span></label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-4">Faculty of <span class="form-required">*</span></label>
                          <div class="col-sm-8">
                ...
                <span class="custom-control-label">1<sup>st</sup> semester</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="semester" id="semester" value="2">
                <span class="custom-control-label">2<sup>nd</sup> semester </span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="semester" id="semester" value="3">
                <span class="custom-control-label">3<sup>rd</sup> semester</span> </label>
											
											</div>
										</div>
                                        </div>
										<div class="form-group">
											<label class="form-label">Academic year <span class="form-required">*</span> </label>
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">I would ask for the permission for late in (payment/document/registration) to the Graduate School, Mahasarakham University as follows:<span class="form-required">*</span></label>
                          <div class="col-sm-12">
                            <label class="custom-control custom-checkbox">
                              <input type="checkbox" id="late_registration" class="custom-control-input" name="late_registration" value="1" >
                              <span class="custom-control-label">1. late registration</span> </label>
                            <label class="custom-control custom-checkbox">
                              <input type="checkbox" id="payment_chk" class="custom-control-input" name="payment_chk" value="1" >
                              <span class="custom-control-label">2. late registration payment,  reason as follow:</span> </label>
                                  <div class="col-sm-12">
                         <label class="custom-control custom-checkbox">
                              <input type="checkbox" id="problem_bank_1" class="custom-control-input" name="problem_bank_1" value="1" >
                              <span class="custom-control-label">2.1 personal problem</span> </label>
                         </div>
                          <div class="col-sm-12">
                         <label class="custom-control custom-checkbox">
                              <input type="checkbox" id="capital_form_chk2" class="custom-control-input" name="capital_form_chk2" value="1" >
                              <span class="custom-control-label">2.2 waiting for scholarship, scholarship’s name:  </span> </label>
                              <input type="text" class="form-control" id="capital_form_2" name="capital_form_2" disabled>
                         </div>
                           <div class="col-sm-12">
                         <label class="custom-control custom-checkbox">
                              postpone registration payment to …………dd/mm/yyyy</label>
                              <input type="date" class="form-control" id="payment_chk_date" name="payment_chk_date" required>
                         </div>
                              
<!--                            <input type="date" class="form-control datepicker" id="payment_chk_date" name="payment_chk_date" placeholder="YYYY-MM-DD">
-->                            <label class="custom-control custom-checkbox">
                              <input type="checkbox" id="evidence_late" class="custom-control-input" name="evidence_late" value="1" >
                              <span class="custom-control-label">3. Guidance for late submission of the confirmation form as follows</span> </label>
                          </div>
                        </div>
                        <!--<input type="text" name="input" placeholder="YYYY-MM-DD" required pattern="(?:19|20)\[0-9\]{2}-(?:(?:0\[1-9\]|1\[0-2\])/(?:0\[1-9\]|1\[0-9\]|2\[0-9\])|(?:(?!02)(?:0\[1-9\]|1\[0-2\])/(?:30))|(?:(?:0\[13578\]|1\[02\])-31))" title="Enter a date in this format YYYY/MM/DD"/>-->
                         ...
                         <label class="custom-control custom-checkbox">
                              ...
                              <span class="custom-control-label">4. Certificate of Examination (For Scholarship Request)</span> </label>
                      <div class="form-group">
                        <div class="row align-items-center">
                           
                           
                              <span class="custom-control-label">I would like to submit the document(s)/payment evident to the Graduate School within dd/mm/yyyy</span> 
                              <input type="date" class="form-control" id="submit_document" name="submit_document" required> If the document was not submitted within this date, I agree to cancel my application/registration.
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                    <div class="form-group col-sm-3">
											<label class="form-label">E-mail<span class="form-required">*</span> </label></div>
											<div class="form-group col-sm-9">
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-2">signature <span class="form-required">*</span></label>
                          <div class="col-sm-3">
                            <div id="signArea"> 
