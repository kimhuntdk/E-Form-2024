...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="digital-e-signature/css/bootstrap.css" rel="stylesheet" />

    <!-- Font Awesome Css -->
    <link href="digital-e-signature/css/font-awesome.min.css" rel="stylesheet" />

	<!-- Bootstrap Select Css -->
    <link href="digital-e-signature/css/bootstrap-select.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="digital-e-signature/css/app_style.css" rel="stylesheet" />
...
<body>
    <div class="all-content-wrapper">
		<!-- Top Bar -->
		<?php require_once('digital-e-signature/include/header.php'); ?>
		<!-- #END# Top Bar -->
					...
					<div class="row">
						<div class="col-md-offset-1 col-md-10">
							<div class="panel panel-default">
								...
								<button id="btnClearSign2">Clar Signature</button>
								<button id="btnSaveSign">Save Signature</button>
		
								<div class="sign-container">
								<?php
								$image_list = glob("./digital-e-signature/doc_signs/*.png");
		...
		$("#btnSaveSign").click(function(e){
			html2canvas([document.getElementById('sign-pad')], {
				onrendered: function (canvas) {
					...
					$.ajax({
						url: 'digital-e-signature/save_sign.php',
