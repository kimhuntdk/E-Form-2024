...
//=========แสดงข้อมูลนิสิตที่ยื่นเอกสาร======================
 $sql = "SELECT * FROM request_doc LEFT JOIN request_change_study_program ON request_doc.doc_id=request_change_study_program.doc_id WHERE request_doc.doc_id=" . $doc_id;
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">คำร้องขอเปลี่ยนแผนการเรียน (ระดับบัณฑิตศึกษา) Request Form to Change Study  (Graduate Student)</h3>
                  </div>
                  <div class="card-body">
                          ...
                          <option value="2554" <?php if($row[ 'academic']=="2554" ) { echo "selected"; } ?>>2554</option>
								...
								<!--		<div class="form-group">
											<div class="row align-items-center">
												...
												<label class="col-sm-12"><strong>มีความประสงค์ขอเปลี่ยนแผนการเรียน/ Would like to change study program</strong>
<span class="form-required">*</span> </label>
									<div class="form-group">
											<div class="custom-controls-stacked">
												<label class="custom-control custom-checkbox">
                <input type="checkbox" id="status_master_phd" class="custom-control-input" name="status_master_phd" value="1" <?php if($row['status_master_phd']=="1") { echo "checked"; } ?> disabled  >
                <span class="custom-control-label">ระดับปริญญาโท/Master  จาก/From </span>
               <!-- <input type="text" class="form-control" id="finished_assignment" placeholder="" disabled>-->
              </label>
              
              	<div class="form-group col-sm-12">
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline"> <?php echo $row['form_program_plan_master'];?>
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="1" <?php if($row['form_program_plan_master']=="1") { echo "checked"; } ?> disabled >
                <span class="custom-control-label">แผน  ก  แบบ  ก 1/Program A Plan A1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="2" <?php if($row['form_program_plan_master']=="2") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แผน  ก  แบบ  ก 2 /Program A Plan A2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="3" <?php if($row['form_program_plan_master']=="3") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แผน  ข/Program B </span> </label>
                                        ...
                                        เป็น/To
											...
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="1" <?php if($row['to_program_plan_master']=="1") { echo "checked"; } ?> disabled >
                <span class="custom-control-label">แผน  ก  แบบ  ก 1/Program A Plan A1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="2" <?php if($row['to_program_plan_master']=="2") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แผน  ก  แบบ  ก 2 /Program A Plan A2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="3" <?php if($row['to_program_plan_master']=="3") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แผน  ข/Program B </span> </label>
												...
												<label class="custom-control custom-checkbox">
                <input type="checkbox" id="status_master_phd" class="custom-control-input" name="status_master_phd" value="2"  <?php if($row['status_master_phd']=="2") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">ระดับปริญญาเอก/ Ph.D   จาก </span>
                <!--<input type="text" class="form-control" placeholder="" id="unstarting_assignment" disabled>-->
               	...
               	<div class="form-group col-sm-12">
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="1" <?php if($row['form_program_plan_phd']=="1") { echo "checked"; } ?> disabled >
                <span class="custom-control-label">แบบ  1.1/Plan 1.1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="2" <?php if($row['form_program_plan_phd']=="2") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  1.2/Plan 1.2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="3" <?php if($row['form_program_plan_phd']=="3") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  2.1/Plan 2.1</span> </label>
                	<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="4" <?php if($row['form_program_plan_phd']=="4") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  2.2/Plan 2.2</span> </label>
                                        ...
                                        เป็น/To
											...
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="1" <?php if($row['to_program_plan_phd']=="1") { echo "checked"; } ?> disabled >
                <span class="custom-control-label">แบบ  1.1/Plan 1.1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="2" <?php if($row['to_program_plan_phd']=="2") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  1.2/Plan 1.2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="3" <?php if($row['to_program_plan_phd']=="3") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  2.1/Plan 2.1</span> </label>
                <label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="4" <?php if($row['to_program_plan_phd']=="4") { echo "checked"; } ?> disabled>
                <span class="custom-control-label">แบบ  2.2/Plan 2.2</span> </label>
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-10">
                            <label class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input" name="chairman_board_status" <?php if($row['chairman_board_status']=="1") { echo "checked"; } ?> id="chairman_board_status" value="1" <?php if($chairman_board_status !=0) { echo "disabled";}?>  >
                              <span class="custom-control-label">อนุมัติ</span> </label>
                            <label class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input" name="chairman_board_status" <?php if($row['chairman_board_status']=="2") { echo "checked"; } ?> id="chairman_board_status" value="2" <?php if($chairman_board_status !=0) { echo "disabled";}?> >
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-10">
                            <textarea name="argument" id="argument" class="form-control" <?php if($chairman_board_status !=0) { echo "disabled";}?>><?php echo $row['chairman_board_node'];?></textarea>
                          </div>
                        </div>
                      </div>
                      <?php
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-2">ลงชื่อ/ signature ประธานกรรมการบริหารหลักสูตร
                            (Chairman of the board of program)<span class="form-required">*</span></label>
                          <div class="col-sm-3">
                            <?php if($chairman_board_status !=0) { 
...
<script type="text/javascript">
	$( document ).ready( function ( e ) {
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			var chairman_board_status = $( "input[type=radio][name=chairman_board_status]:checked" ).val();
			var argument = $( "#argument" ).val();
			var doc_id = $( "#doc_id" ).val();
			var std_id = $("#std_id").val();
			var sig_chk = $( "#signArea" ).signaturePad().validateForm();
			if ( chairman_board_status === undefined ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Chairman_update_change_study_program.php", {
						img_data: img_data,
						chairman_board_status: chairman_board_status,
