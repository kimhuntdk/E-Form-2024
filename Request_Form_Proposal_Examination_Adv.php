			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/save_proposal_examination_adv.php", {
							img_data: img_data,
							std_id: std_id,
							semester: semester,
							academic: academic,
							...
							if ( data == 1 ) {
								$.post(
									"digital-e-signature/save_proposal_examination_array_adv.php",
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องแต่งตั้งกรรมการสอบเค้าโครงวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ</h3>
								</div>
								<div class="card-body">
