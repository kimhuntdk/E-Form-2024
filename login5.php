							...
							<div class="col col-login mx-auto">
								...
								<form class="frm_login" action="javascript:;" method="post" id="frm_login" name="frm_login">
									<div class="card-body p-6">
                                        ...
                                        <img src="captcha/captcha_img.php" style="width=250px;"><input type="text" name="capt" id="capt" class="form-control">
										<a href="login.php">เปลี่ยนใหม่</a>
                                        </div>
										
										<div class="form-footer">
											<button type="submit" name="submit"  class="btn btn-primary btn-block" id="hash-it" onclick="return login()">Sign in</button>
										</div>
