                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tbody>
                            <tr>
                              <td><b>ชื่อ</b> <?php echo $row_name['std_fname_th']; ?>&nbsp;<?php echo $row_name['std_lname_th']; ?>&nbsp;&nbsp;
                                <b>รหัสประจำตัวนิสิต</b>&nbsp; <?php echo $row_name['std_id_std']; ?>&nbsp;<?php echo $row_name['std_degree_th']; ?> &nbsp;<?php echo $row_name['std_faculty_th']; ?> &nbsp;
                                <b>สาขา</b><?php echo $row_name['std_major_th']; ?>
                              </td>
                            </tr>
                            <tr>
                              <td></td>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="custom-controls-stacked">
                              ...
                              <label class="custom-control custom-radio custom-control-inline">
                                ...
                                <span class="custom-control-label">ภาคพิเศษ/3<sup>rd</sup> semester </span>
                              </label>
                            </div>
                          </div>
                          <div class="col-md-6">
              ...
              <option value="5" <?php if($row[dean_admin] ==5) { echo "selected";}?>>รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ</option>
                    ...
                    <div class="form-group">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-10">
                          <textarea name="registration_division_node" id="registration_division_node" class="form-control" placeholder="เหตุผลเจ้าหน้าที่ทะเบียน" <?php if ($registration_division_node != 0) {
                                                                                                                                                                    echo "disabled";
...
<script type="text/javascript">
  $(document).ready(function(e) {
    ...
    $("#btnSaveSign").click(function(e) {
      ...
      $.post(
        "digital-e-signature/update_registerar_Retaining_student_status.php",
