                  ...
                  <div class="card-body">
                   <div id="show_loading" align="center"></div>
                    ...
                    <form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      ...
                      <div class="form-group col-sm-9">
                        <div class="custom-controls-stacked">
                          <label class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" name="type_thesis" <?php if($row['status_thesis_is']=="Thesis") { echo "checked"; } ?> id="type_thesis" value="Thesis" disabled >
                            <span class="custom-control-label">Thesis</span> </label>
                          <label class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" name="type_thesis" <?php if($row['status_thesis_is']=="IS") { echo "checked"; } ?> id="type_thesis" value="IS" disabled>
                      ...
                      <div class="form-group">
                        <div class="row align-items-right">
                          ...
                          <div class="col-sm-2">
                            <input type="text" class="form-control" placeholder="รหัสวิชา" id="subject_code" name="subject code" value="<?php echo $row['subject_code'];?>" disabled>
                          </div>
					...
					?>
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-2">ลงชื่อ/ signature อาจารย์ที่ปรึกษา/ประธานควบคุมบทนิพนธ์<span class="form-required">*</span></label>
                          <div class="col-sm-10">
              ...
              <label class="custom-control custom-checkbox">
                ...
                <input type="text" class="form-control" placeholder="" id="unstarting_assignment" disabled>
                      ...
                      <div class="btn-list mt-4 text-left">
                        ...
                        <button type="reset" class="btn btn-secondary btn-space" <?php if($advisor_chairman_status !=0) { echo "disabled";}?>>Cancel</button>
                      </div>
                    </form>
                  </div>
                </div>
      ...
      var academic = $( "#academic" ).val();
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/update_status.php", {
						img_data: img_data,
