			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/save_proposal_examination.php", {
							img_data: img_data,
							semester: semester,
							academic: academic,
					 		email:email, 
							...
							if ( data == 1 ) {
								$.post(
									"digital-e-signature/save_proposal_examination_array.php",
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องแต่งตั้งกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ</h3>
								</div>
								<div class="card-body">
									<div id="show_loading" align="center"></div>
									<form action="Javascript:void(0);" method="post" id="frm_add_proposal" class="frm_add_proposal">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12">มีความประสงค์แต่งตั้งคณะกรรมการสอบโครงร่าง</label>
											</div>
										</div>
                ...
                <span class="custom-control-label">ภาคการศึกษาพิเศษ/ 3<sup>nd</sup> semester</span> </label>
										...
										<div class="form-group">
											...
											<select class="form-control" id="academic" name="academic">
												...
												<option value="2565">2565</option>										<option value="2564">2564</option>
										...
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">เลือกชื่อคณะกรรมการสอบ
												...
												<div class="col-sm-9">
                                                    ...
                                                    <button onclick="appendText()" id="button_id" class="btn btn-danger">Add</button>
												</div>
											</div>
										</div>
                                        	<div class="form-group">
                                         ...
                                         <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">อาจารย์ทีปรึกษา
 <span class="form-required">*</span></label>
												<div class="col-sm-9">
													<select id="chairman" name="chairman" class="custom-select">
														...
														$contents = utf8_encode( $contents );
														$results = json_decode( $contents );
														echo "<option value='0'>กรุณาเลือกอาจารย์ที่ปรึกษา</option>";
														foreach ( $results as $key => $value ) {
															foreach ( $value as $k => $v ) {
																if ( $k == "officercode" ) {
																	echo "<option value='$v'>";
