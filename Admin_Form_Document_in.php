...
$sql_name = "SELECT staff_name,staff_id,staff_position FROM request_staff WHERE staff_id='$row[staff_id]' ";
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              <tr>
                                <td><b>ชื่อ</b> <?php echo $row_name['staff_name'];?>&nbsp;</td>
                              </tr>
                              <tr>
                                <td></td>
                              </tr>
                    ...
                    <form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                       <div class="form-group">
                        <div class="row align-items-center">
                          ...
                          <?php if($row['dean_admin'] ==2) { echo "คณบดีบัณฑิตวิทยาลัย";}?>
                          <?php if($row['dean_admin'] ==3) { echo "รองคณบดีบัณฑิตวิทยาลัย ฝ่ายบริหาร";}?>
                          <?php if($row['dean_admin'] ==4) { echo "รองคณบดีบัณฑิตวิทยาลัย ฝ่ายวิชาการ ";}?>
                         <?php if($row['dean_admin'] ==5) { echo "รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ";}?>
                        </select>
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                      	...
                      	<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">ลงชื่อ/ signature ผู้ยื่นบันทึกข้อความ<span class="form-required">*</span></label>
												<div class="col-sm-9"> <img src="digital-e-signature/doc_signs/<?=$row['per_signature'];?>.png">
													<?php echo $row_name['staff_name'];?>&nbsp;
													<?php echo $row_name['staff_position'];?> </div>
											</div>
										</div>
                      <div class="form-group">
                        <div class="row align-items-center">
				 	...
				 	echo $row_ad['staff_name'];  ?>
                      ...
                      <div class="btn-list mt-4 text-left">
                        <input type="hidden" name="doc_id" id="doc_id" value="<?=$doc_id;?>">
                         <input type="hidden" name="staff_id" id="staff_id" value="<?=$row_name['staff_id'];?>">
                        <input type="hidden" name="Save_Admin_Doc_in" value="Save_Admin_Doc_in">
...
$(document).ready(function(e){
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
						...
						$.post( "digital-e-signature/update_admin_document_in.php", {
						img_data:img_data,dean_admin_approve_disapprove:dean_admin_approve_disapprove,
						argument:argument, doc_id:doc_id,staff_id:staff_id
					}, function ( data ) {
