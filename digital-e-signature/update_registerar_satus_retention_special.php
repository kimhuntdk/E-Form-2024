<?php 
	...
	if($registration_division_status !=''){
		// อาจารย์ได้พิจารณาอกสารคำร้องลาพักการเรียน request_registration_thesis_is
		 $sql = "Update request_status_retention set registration_division_status='$registration_division_status',registration_division_node='$argument' Where doc_id='$doc_id' ";
		...
		if($rs_doc){
			...
			$date_now_th = DateThai1(date('Y-m-d H:i:s'));
				...
				$mail->Subject = "[e-Form Graduate MSU] นิสิตได้ส่งคำร้อง “คำร้องรักษาสภากรณีพิเศษ”";  //หัวเรื่อง emal ที่ส่ง
