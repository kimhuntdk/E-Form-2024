<?php 
	...
	$result = array();
	isset($_SESSION['SES_STDNAME_FULL_TH']);
	...
	if($advisor_chairman_status !=''){
		// อาจารย์ได้พิจารณาอกสารคำร้องขอคืนสภาพการเป็นนิสิต request_retaining_student_status
		$sql = "Update request_retaining_student_status set advisor_chairman_status='$advisor_chairman_status',advisor_chairman_node='$argument',advisor_chairman_signature='$filename',advisor_chairman_date=Now() Where doc_id='$doc_id' ";
	...
	เรื่อง คำร้องขอคืนสภาพการเป็นนิสิต Retaining Student Status <br><br>
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “ขอคืนสภาพการเป็นนิสิต” ภาคเรียนที่ $semester/$academic ของนิสิตชื่อ $row_std[std_fname_th] $row_std[std_lname_th] รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th  ได้โปรดรพิจารณาลงนามคำร้อง “ขอคืนสภาพการเป็นนิสิต Retaining Student Status” 
