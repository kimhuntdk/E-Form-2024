<?php 
	...
	if($dean_admin_approve_disapprove !=''){
		...
		$sql = "Update request_registration_thesis_is set dean_admin_approve_disapprove='$dean_admin_approve_disapprove',dean_admin_node='$argument',dean_admin_signature='$filename',dean_admin_date=Now() Where doc_id='$doc_id' ";
