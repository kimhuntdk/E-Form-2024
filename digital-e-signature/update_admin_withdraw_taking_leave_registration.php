<?php 
	...
	if($dean_admin_approve_disapprove !=''){
		...
		$sql = "Update request_withdraw_taking_leave_registration set dean_admin_approve_disapprove='$dean_admin_approve_disapprove',dean_admin_node='$argument',dean_admin_signature='$filename',dean_admin_date=Now() Where doc_id='$doc_id' ";
	...
	"; //รายละเอียดที่ส่ง
				$mail->AddAddress('diskko@hotmail.com','เจ้าหน้าที่กองทะเบียน'); 
