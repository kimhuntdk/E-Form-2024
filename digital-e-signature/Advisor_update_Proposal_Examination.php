<?php 
    ...
    $std_id = $mysqli->real_escape_string($_REQUEST['std_id']);
	if($advisor_chairman_status !=''){
		// อาจารย์ได้พิจารณาอกสารคำร้องลาพักการเรียน request_registration_thesis_is
		$sql = "Update request_proposal_examination set advisor_status='$advisor_chairman_status',advisor_node='$argument',advisor_signature='$filename',advisor_date_signature=Now() Where doc_id='$doc_id' ";
		...
		if($rs_doc){
			...
			$std_fname_en = $row_std['std_fname_en'];
			$std_lname_en = $row_std['std_lname_en'];
			...
			$std_name_full = $std_fname_en." ".$std_lname_en;
			//=====================Seach Staff=================
			...
			if($staff_email !='') {
				...
				$mail->Subject = "[e-Form Graduate MSU] นิสิตได้ส่งคำร้อง “แต่งตั้งคณะกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ”";  //หัวเรื่อง emal ที่ส่ง
				$mail->Body = "เรียนเจ้าหน้าที่บัณฑิตวิทยาลัย<br>
	เรื่อง คำร้องแต่งตั้งคณะกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ  <br><br>
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “แต่งตั้งคณะกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ”  ของนิสิตชื่อ $std_name_full รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th  ได้โปรดรพิจารณาลงนามคำร้อง “แต่งตั้งคณะกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ” 
	...
	"; //รายละเอียดที่ส่ง
				$mail->AddAddress('jakkrid.b@msu.ac.th','เจ้าหน้าที่คณะ'); //อีเมล์และชื่อผู้รับ
