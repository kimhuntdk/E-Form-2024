<?php 
	...
	if($advisor_chairman_status !=''){
		...
		$sql = "Update request_appointment_advisor set advisor_status='$advisor_chairman_status',advisor_node='$argument',advisor_signature='$filename',advisor_date_signature=Now() Where doc_id='$doc_id' ";
	...
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “แต่งตั้งชื่อเรื่องวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ”  ของนิสิตชื่อ $std_name_full รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th  ได้โปรดรพิจารณาลงนามคำร้อง “แต่งตั้งชื่อเรื่องวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ” 
