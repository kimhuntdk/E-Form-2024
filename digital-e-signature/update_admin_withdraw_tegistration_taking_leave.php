<?php 
	...
	if($dean_admin_approve_disapprove !=''){
		...
		$sql = "Update request_withdraw_registration_taking_leave set dean_admin_approve_disapprove='$dean_admin_approve_disapprove',dean_admin_node='$argument',dean_admin_signature='$filename',dean_admin_date=Now() Where doc_id='$doc_id' ";
		...
		if($rs_doc){
			...
			$date_now_th = DateThai1(date('Y-m-d H:i:s'));
				...
				$mail->Subject = "[e-Form Graduate MSU] นิสิตได้ส่งคำร้อง “ขอถอนการลงทะเบียนเพื่อลาพักการเรียน”";  //หัวเรื่อง emal ที่ส่ง
				$mail->Body = "เรียนเจ้าหน้าที่กองทะเบียน<br>
	เรื่อง คำร้องขอถอนการลงทะเบียนเพื่อลาพักการเรียน  <br><br>
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “ขอถอนการลงทะเบียนเพื่อลาพักการเรียน” ของนิสิตชื่อ $std_name_full รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th   
	...
	"; //รายละเอียดที่ส่ง
				$mail->AddAddress('kim_4692@hotmail.com','เจ้าหน้าที่กองทะเบียน'); //อีเมล์และชื่อผู้รับ
