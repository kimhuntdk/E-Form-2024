<?php 
	...
	if($registration_division_status !=''){
		...
		$sql = "Update request_registration_thesis_is set registration_division_status='$registration_division_status',registration_division_node='$argument' Where doc_id='$doc_id' ";
