<?php 
	...
	if($advisor_chairman_status !=''){
		...
		$sql = "Update request_return_work set advisor_chairman_status='$advisor_chairman_status',advisor_chairman_node='$argument',advisor_chairman_signature='$filename',advisor_chairman_date=Now() Where doc_id='$doc_id' ";
	...
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “ขอกลับเข้ารับราชการ” ภาคเรียนที่ $semester/$academic ของนิสิตชื่อ $_SESSION[SES_STDNAME_FULL_TH] รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th  ได้โปรดรพิจารณาลงนามคำร้อง “ลาพักการเรียน” 
