<?php 
	...
	if($dean_admin_approve_disapprove !=''){
		...
		$sql = "Update request_document_student_grad set dean_admin_approve_disapprove='$dean_admin_approve_disapprove',dean_admin_node='$argument',dean_admin_signature='$filename',dean_admin_date=Now() Where doc_id='$doc_id' ";
	...
	เรื่อง บันทึกข้อความ   <br><br>
	ระบบ e-Form Graduate MSU ได้ส่งคำร้อง “บันทึกข้อความ” ของนิสิตชื่อ $std_name_full รหัส $std_id_std  นิสิต$std_degree_th คณะ$std_faculty_th เมื่อ$date_now_th   
