<?php 
	...
	if($advisor_chairman_status !=''){
		...
		$sql = "Update request_change_study_program set advisor_chairman_status='$advisor_chairman_status',advisor_chairman_node='$argument',advisor_chairman_signature='$filename',advisor_chairman_date=Now() Where doc_id='$doc_id' ";
