<?php 
	...
	if($chairman_board_status !=''){
		// อาจารย์ได้พิจารณาอกสารคำร้องลาพักการเรียน request_registration_thesis_is
		 $sql = "Update request_change_field_study set chairman_board_status='$chairman_board_status',chairman_board_node='$argument',chairman_board_signature='$filename',chairman_board_date=Now() Where doc_id='$doc_id' ";
	...
	เรื่อง คำร้องขอเปลี่ยนสาขาวิชา  <br><br>
