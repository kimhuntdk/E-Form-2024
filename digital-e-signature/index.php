...
<body>
					...
					<div class="row">
						<div class="col-md-offset-1 col-md-10">
							<div class="panel panel-default">
								...
								<button id="btnSaveSign" class="btnSaveSign">Save Signature</button>
	...
	$(document).ready(function(e){
		...
		$(document).ready(function() {
			 $('#signArea').signaturePad({drawOnly:true, drawBezierCurves:true, lineTop:99});
		});
