...
$(document).ready(function(e){
	 ...
	 // alert("OK");
      ...
      var registration_division_status = $( "#registration_division_status" ).val();
            ...
            $.post( 
                  "digital-e-signature/update_registerar_satus_retention_special.php",
                  $("#frm_add_thesis_is").serializeArray(),
                  function(data) {
					 //alert(data);
           if(data==1){
							alert("Send Data Complete..");
							 window.location.href = 'staff_registrar.php';
						} else if(data==2) {
        ...
        <div class="form-group">
          ...
          <div class="form-group">
                    <div class="row align-items-center">
                          ...
                          <div class="col-sm-10">
                       <select name="registration_division_status" id="registration_division_status"  class="form-control" >
                        <option value="0">รอดำเนินการ</option>
                        <option value="1">ดำเนินการเรียบร้อย</option>
                        <option value="99">ไม่สามารถดำเนินการได้</option>
                       </select>
                      </div>
                        </div>
                  </div>
                  <div class="form-group">
                    <div class="row align-items-center">
                          <label class="col-sm-2">เหตุผล</label>
                          <div class="col-sm-10">
                        <textarea name="registration_division_node" id="registration_division_node" class="form-control" <?php if($registration_division_node !=0) { echo "disabled";}?>><?php echo $row['registration_division_node'];?></textarea>
                      </div>
                        </div>
                  </div>
                    ...
                    <button type="submit" id="btnSaveSign"  class="btn btn-primary btn-space update_btn" <?php if($registration_division_status !=0) { echo "disabled";}?>>Save Data</button>
                    <button type="reset" class="btn btn-secondary btn-space" <?php if($registration_division_status !=0) { echo "disabled";}?>>Cancel</button>
                  </div>
          </form>
            </div>
      </div>
