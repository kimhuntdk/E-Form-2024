                      ...
                      <div class="form-group">
                        <div class="custom-controls-stacked">
                          <label class="custom-control custom-checkbox">
                            ...
                            <input type="text" class="form-control" id="finished_assignment" value="<?=$row['finished_assigment'];?>" placeholder="" disabled>
                          </label>
                          <label class="custom-control custom-checkbox">
                            ...
                            <input type="text" class="form-control" placeholder="" id="unfinished_assignment" value="<?=$row['unfinished_assignment'];?>"  disabled>
                          </label>
                          <label class="custom-control custom-checkbox">
                            ...
                            <input type="text" class="form-control" placeholder="" id="unstarting_assignment" value="<?=$row['unstarting_assignment'];?>" disabled>
                          </label>
                        </div>
                      </div>
                      <div class="form-group">
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/update_status_atl.php", {
						img_data: img_data,
