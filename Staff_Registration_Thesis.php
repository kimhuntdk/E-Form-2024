            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Request Form for Registration for Thesis/IS</h3>
                </div>
                <div class="card-body">
                  ...
                  <form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      ...
                      <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input" name="type_thesis" <?php if ($row['status_thesis_is'] == "Thesis") {
                                                                                                echo "checked";
                                                                                              } ?> id="type_thesis" value="Thesis" <?php if ($staff_grad_approve_disapprove != 3) {
                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                  } ?>>
                        ...
                        <label class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input" name="type_thesis" <?php if ($row['status_thesis_is'] == "IS") {
                                                                                                echo "checked";
                                                                                              } ?> id="type_thesis" value="IS" <?php if ($staff_grad_approve_disapprove != 3) {
                                                                                                                                                                                            echo "disabled";
                                                                                                                                                                                          } ?>>
                    ...
                    <div class="form-group">
                      <div class="row align-items-right">
                        ...
                        <div class="col-sm-2">
                          <input type="text" class="form-control" placeholder="รหัสวิชา" id="subject_code" name="subject code" value="<?php echo $row['subject_code']; ?>" <?php if ($staff_grad_approve_disapprove != 3) {
                                                                                                                                                                            echo "disabled";
                                                                                                                                                                          } ?>>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select" id="dean_admin" name="dean_admin" disabled <?php if ($staff_grad_approve_disapprove != 0) {
                                                                                                  echo "disabled";
                                                                                                } ?>>
