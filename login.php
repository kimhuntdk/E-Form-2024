...
if (isset($_POST['pass'])) {
	...
	// ต่อไปทำสิ่งอื่น ๆ ที่ต้องการ
} else {
	// กรณี 'pass' ไม่ได้ถูกส่งมา
					...
					<div class="col-12">
						<div class="row">
							<div class="col col-login mx-auto">
								...
								<form class="card frm_login" action="javascript:;" method="post" id="frm_login" name="frm_login" style="border-radius: 2rem;">
									<div class="card-body p-6">
										...
										<br>
										<div class="col col-lg-6">
											<input name="i_verify" type="text" id="i_verify" maxlength="2" class="form-control" />
										</div>

										<div class="form-footer">
											<button type="submit" name="submit" class="btn btn-primary btn-block" id="hash-it" onclick="return login()" value="submit">Sign in</button>
										</div>
...
<script type="text/javascript">
	function login() {
		...
		if (i_verify == "") {
			alert("Please Captcha");
			$("#capt").focus();
			return false;
		}

		// สำหรับนิสิต
		if (user !== "" && pass !== "" && status !== 0 && i_verify !== "") {
			$.post("check_login.php", {
				...
				if (data == 1) {
					...
					// ยกเลิกคอมเม้นเมื่อ service กองทะเบียนกับมาใช้ได้ 
					...
					alert("โปรดระบุ Captcha ให้ถูกต้อง");
