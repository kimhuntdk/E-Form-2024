...
header("Content-Disposition: attachment; filename=thesis.doc");*/
require_once( "inc/db_connect.php" );
$mysqli = connect();
//== ขอหนังสือแต่งตั้งชื่อเรื่อง
$doc_id = base64_decode( $_GET['doc_id'] );
$sql_aa = "SELECT * FROM request_doc INNER JOIN request_thesis_examination ON request_doc.doc_id=request_thesis_examination.doc_id INNER JOIN request_student ON request_thesis_examination.std_code=request_student.std_id_std WHERE request_thesis_examination.doc_id=" . $doc_id;
...
<link rel=File-List href="ts0000000001.files/filelist.xml">
<link rel=Edit-Time-Data href="ts0000000001.files/editdata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2020-08-05T02:23:00Z</o:Created>
  <o:LastSaved>2020-08-05T02:24:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>512</o:Words>
...
<link rel=dataStoreItem href="ts0000000001.files/item0011.xml"
target="ts0000000001.files/props012.xml">
<link rel=themeData href="ts0000000001.files/themedata.thmx">
<link rel=colorSchemeMapping href="ts0000000001.files/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
  <w:View>Print</w:View>
...
.MsoChpDefault
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("ts0000000001.files/header.htm") fs;
	mso-footnote-continuation-separator:url("ts0000000001.files/header.htm") fcs;
	mso-endnote-separator:url("ts0000000001.files/header.htm") es;
	mso-endnote-continuation-separator:url("ts0000000001.files/header.htm") ecs;}
@page WordSection1
	{size:595.3pt 841.9pt;
	margin:35.45pt 56.65pt 7.1pt 63.8pt;
	mso-header-margin:36.0pt;
	mso-footer-margin:11.15pt;
	mso-footer:url("ts0000000001.files/header.htm") f1;
	mso-paper-source:0;}
div.WordSection1
	{page:WordSection1;}
 /* List Definitions */
...
@list l24:level1
	...
	text-indent:-18.0pt;}
@list l25
	{mso-list-id:1712336806;
	mso-list-type:hybrid;
	mso-list-template-ids:-673407232 -1268981588 67698713 67698715 67698703 67698713 67698715 67698703 67698713 67698715;}
@list l25:level1
...
<p class=MsoNormal align=center style='text-align:center'><!--[if gte vml 1]><v:shapetype
 ...
 <v:imagedata src="ts0000000001.files/image003.png" o:title=""/>
</v:shape><![endif]--></p>
<p align="center"><img src="images/image004.png" width="79" height="103" alt=""/></p>
...
<h3><span lang=TH style='font-size:14.0pt;font-family:"TH SarabunPSK","sans-serif"'>แบบขออนุมัติสอบวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ
<br>
และแต่งตั้งคณะกรรมการสอบวิทยานิพนธ์</span><span style='font-size:14.0pt;
font-family:"TH SarabunPSK","sans-serif"'>/<span lang=TH>การศึกษาค้นคว้าอิสระ</span>
<o:p></o:p></span></h3>

<p class=MsoNormal align=center style='text-align:center'><span
style='font-family:"TH SarabunPSK","sans-serif"'>-------------------------------------<o:p></o:p></span></p>

<p class=MsoNormal1 style='margin-right:-28.4pt'><span lang=TH style='font-family:
"TH SarabunPSK","sans-serif"'>ข้าพเจ้า<span style='mso-spacerun:yes'>&nbsp; </span></span><span style='font-family:"TH SarabunPSK","sans-serif"'>(<span
lang=TH>นาย</span>/<span lang=TH>นาง</span>/<span lang=TH>นางสาว</span>)
  <?=$row_aa['std_fname_th'];?>
  &nbsp;
  <?=$row_aa['std_lname_th'];?>
  <span
...
<p class=MsoNormal1 style='margin-right:-21.3pt'><span lang=TH style='font-family:
...
<p class=MsoNormal style='margin-right:-28.4pt'>&nbsp;</p>

<p class=MsoNormal><span lang=TH style='font-family:"TH SarabunPSK","sans-serif"'>ขออนุมัติสอบวิทยานิพนธ์
และแต่งตั้งคณะกรรมการสอบวิทยานิพนธ์</span><span style='font-family:
"TH SarabunPSK","sans-serif"'>/<span lang=TH>การศึกษาค้นคว้าอิสระ</span>
<o:p></o:p></span></p>
...
<p class=MsoNormal style='margin-left:36.0pt;text-indent:-18.0pt;mso-list:l25 level1 lfo33'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-family:"TH SarabunPSK","sans-serif";
mso-fareast-font-family:"TH SarabunPSK"'><span style='mso-list:Ignore'>1.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
lang=TH style='font-family:"TH SarabunPSK","sans-serif"'>รายชื่อคณะกรรมการสอบวิทยานิพนธ์</span></b><span
style='font-family:"TH SarabunPSK","sans-serif"'>/<span lang=TH>การศึกษาค้นคว้าอิสระ</span>.
    <o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:36.0pt'><span style='font-family:"TH SarabunPSK","sans-serif"'><o:p><?php

                                                 $sql_exam = "SELECT * FROM request_examination_list WHERE doc_id=" . $doc_id;
                                                 $result_exam = $mysqli->query( $sql_exam );
												 foreach($result_exam as $row_exam){
													 echo $row_exam['exam_name']." ".$row_exam['exam_posi'];
													 echo "<br>";
												 }
...
<p class=MsoNormal style='margin-left:36.0pt;text-indent:-18.0pt;mso-list:l25 level1 lfo33'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-family:"TH SarabunPSK","sans-serif";
mso-fareast-font-family:"TH SarabunPSK"'><span style='mso-list:Ignore'>2.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b><span
lang=TH style='font-family:"TH SarabunPSK","sans-serif"'>วันสอบ</span></b><b><span
style='font-family:"TH SarabunPSK","sans-serif"'>/<span lang=TH>ห้องสอบ</span></span></b><span
style='font-family:"TH SarabunPSK","sans-serif"'><o:p></o:p>
</span>:<span style="font-family:&quot;TH SarabunPSK&quot;,&quot;sans-serif&quot;">
<?=$row_aa['exam_day'];?>
</span><span style="font-family:&quot;TH SarabunPSK&quot;,&quot;sans-serif&quot;">
<?=$row_aa['exam_room'];?>&nbsp;<?=$row_aa['exam_time'];?>
</span></p>

<p class=MsoListParagraph><span lang=TH style='font-size:17.5pt;mso-ansi-font-size:
14.0pt;font-family:"TH SarabunPSK","sans-serif"'><o:p>&nbsp;</o:p></span></p>

<p class=MsoNormal style='margin-left:36.0pt'><span lang=TH style='font-family:
...
lang=TH>ลงชื่อ</span><?php if($row_aa['std_signature']!="") { ?><img src="digital-e-signature/doc_signs/<?=$row_aa['std_signature'];?>.png"><?php } else { } ?><span
...
style='mso-spacerun:yes'>&nbsp;(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>(<span class="MsoNormal" style="margin-left:-14.2pt">
<?=$row_aa['std_fname_th'];?>
<?=$row_aa['std_lname_th'];?>
</span>)<span
...
<p class=MsoNormal style='tab-stops:14.2pt'><b><span style='font-family:"TH SarabunPSK","sans-serif"'><span
...
<p class=MsoNormal style='margin-left:-14.2pt'><span style='font-family:"TH SarabunPSK","sans-serif"'><span
style='mso-tab-count:2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><b> </b></span></p>
<p class=MsoNormal2 style='margin-left:-14.2pt'><span style='font-family:"TH SarabunPSK","sans-serif"'><span
style='mso-tab-count:2'>&nbsp; </span><b><span
lang=TH> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (<span style='mso-spacerun:yes'>
  <?php if($row_aa['advisor_status']==1){ echo "/"; }?>
  </span>)</span></b><span
style='mso-spacerun:yes'>&nbsp; </span><b><span lang=TH>อนุมัติ</span></b>
  <o:p></o:p>
</span></p>
<p class=MsoNormal2 style='margin-left:-14.2pt;text-indent:50.2pt'><b><span
lang=TH style='font-family:"TH SarabunPSK","sans-serif"'>(<span
style='mso-spacerun:yes'>
  <?php if($row_aa['advisor_status']==2){ echo "/"; }?>
  </span>)</span></b><span
style='font-family:"TH SarabunPSK","sans-serif"'><span
style='mso-spacerun:yes'>&nbsp; </span><b><span lang=TH>ไม่อนุมัติ</span></b><span
lang=TH> <span style='mso-spacerun:yes'>&nbsp;</span>เนื่องจาก</span>
  <o:p></o:p>
</span></p>
...
<p class=MsoNormal style='margin-left:-14.2pt'><span style='font-family:"TH SarabunPSK","sans-serif"'><span
style='mso-tab-count:4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><span
lang=TH>ลงชื่อ</span><?php if($row_aa['advisor_signature']!="") { ?>
...
style='mso-tab-count:4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><span
style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span><?php echo DateThai1($row_aa['advisor_date_signature']);?></span></p>
