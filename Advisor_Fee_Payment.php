              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">คำร้องชำระค่าธรรมเนียมการศึกษา (ระดับบัณฑิตศึกษา)Request Form for Fee Payment (Graduate Student)</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">มีความประสงค์<span class="card-title">ชำระค่าธรรมเนียมการศึกษา</span><span class="form-required">*</span> </label>
                        </div>
                      </div>
                     ...
                     <div class="form-group">
											<div class="row align-items-center">
												...
												<div class="form-group col-sm-9">
											     <div class="custom-controls-stacked">
													<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input"  value="1" name="Because" id="Because" <?php if($row[ 'because_status']==1 ) { echo "checked"; } ?>>เนื่องจาก/ because <span class="form-required">*</span> <span class="custom-control-label">เรียนครบหลักสูตรแต่ยังไม่สำเร็จการศึกษา (I have completed all required course, but I am not graduated yet</span>
                </label>
												</div>
                                                </div>
											</div>
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_fee_payment.php", {
						img_data: img_data,
