...
//== คำร้องขอลงทะเบียนรักษาสภาพ (กรณีพิเศษ)
  $sql_srfs = "SELECT * FROM request_doc LEFT JOIN request_status_retention ON request_doc.doc_id=request_status_retention.doc_id WHERE request_status_retention.staff_grad_approve_disapprove=1 AND request_doc.doc_date > '2023-01-16 08:30:00' AND request_status_retention.registration_division_status=0 $keyword_key $keyword_doc_type";
...
$sum_d = $num_count_thesis_d+$num_count_leave_d+$num_count_retention_d; 
...
$sum_s = $num_count_thesis_s + $num_count_leave_s + $num_count_retention_s;
...
$sum_d_d = $num_count_thesis_d_d+$num_count_leave_d_d+$num_count_retention_d_d; 
...
$sum_s_s = $num_count_thesis_s_s + $num_count_leave_s_s + $num_count_retention_s_s;
?>
<!doctype html>
<html lang="en">
								...
								if($registration_division_status==0){ ?>
											...
											<tr>
												...
												<td class="text-center">
													<div class="item-action dropdown">
														<a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a href="Registrar_Taking_Leave.php?doc_id=<?=base64_encode($row_tl['doc_id']);?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a><?php /*?> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview 
                                   ...
                                   <!-- รักษาสภาพ -->
                                        ...
                                        <tr>
											...
											<td class="text-center">
												<div class="item-action dropdown">
													<a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
													<div class="dropdown-menu dropdown-menu-right"> <a href="Registrar_Status_Retention_Special.php?doc_id=<?=base64_encode($row_srfs['doc_id']);?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a>  </div>
										    </td>
											<td>
		...
		var doc_type = $( this ).attr( "data-doctype" );
         ...
         // alert(type_doc);
            $.ajax({
                ...
                type: 'POST',
                data: { chk_id: chk_id,type_doc:type_doc },
