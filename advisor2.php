...
$mysqli = connect();
//== ลงทะเบียนเพิ่ม
echo $sql = "SELECT * FROM request_doc LEFT JOIN request_registration_thesis_is ON request_doc.doc_id=request_registration_thesis_is.doc_id WHERE request_registration_thesis_is.advisor_chairman=" . $SES_USER;
										  ...
										  <?php
											...
											foreach ( $result_wtlr as $row_wtlr ) {
												...
												<td class="text-center">
													<div class="item-action dropdown">
														<a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-settings"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a href="Advisor_Withdraw_Taking_Leave_Registration_Test.php?doc_id=<?=base64_encode($row_wtlr[doc_id]);?>" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a>
															<!-- <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-file"></i> Perview </a>-->
														</div>
												</td>
												<td>
