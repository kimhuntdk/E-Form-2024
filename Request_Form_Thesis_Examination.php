			  ...
			  if ( semester === undefined ) {
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/save_thesis_examination.php", {
							img_data: img_data,
							semester: semester,
							academic: academic,
					 		email:email, 
							...
							if ( data == 1 ) {
								$.post(
									"digital-e-signature/save_thesis_examination_array.php",
											...
											<div class="row align-items-center">
												...
												<div class="col-sm-9">
													<select id="advisor" name="advisor" class="custom-select">
														...
														echo "<option value='0'>กรุณาเลือกชื่อกรรมการสอบ</option>";
