...
var signaturePad = new SignaturePad(document.getElementById('signature-pad'), {
    ...
    penColor: 'rgb(10, 16, 206)', // rgb(10, 16, 206)
    velocityFilterWeight: 0.7, // 0.7
    minWidth: 0.7,  //  0.7
    maxWidth: 1.5, //   1.5
    throttle: 15, // max x milli seconds on event update, OBS! this introduces lag for event update
    minPointDistance: 5,
});
