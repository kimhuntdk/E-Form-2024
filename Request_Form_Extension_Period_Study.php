	...
	<div class="page">
		<div class="page-main">
			...
			<div class="my-3 my-md-5">
                ...
                <input type="radio" class="custom-control-input" name="semester_enroll" id="semester_enroll" value="1" >
                <span class="custom-control-label">ภาคต้น/ 1<sup>st</sup> semester</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="semester_enroll" id="semester_enroll" value="2">
                <span class="custom-control-label">ภาคปลาย/ 2<sup>nd</sup> semester </span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="semester_enroll" id="semester_enroll" value="3">
                <span class="custom-control-label">ภาคการศึกษาพิเศษ/ 3<sup>nd</sup> semester</span> </label>
											...
											<select class="form-control" id="academic_enroll" name="academic_enroll">
...
<span class="form-required">*</span> </label>
                ...
                <input type="checkbox" id="subjects_not_ompleted" class="custom-control-input" name="subjects_not_ompleted" value="1" >
                <span class="custom-control-label">เรียนวิชาต่างๆไม่ครบถ้วน  (Subjects are not completed) </span>
               
              </label>
											
												<label class="custom-control custom-checkbox">
                <input type="checkbox" id="failed_exam" class="custom-control-input" name="failed_exam" value="1">
                <span class="custom-control-label">สอบประมวลผลความรู้ไม่ผ่าน  (Failed in the Exam)</span>
            
              </label>
											
												<label class="custom-control custom-checkbox">
                <input type="checkbox" id="thesis_not_completed" class="custom-control-input" name="thesis_not_completed" value="1" >
