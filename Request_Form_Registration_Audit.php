						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องขอลงทะเบียนเรียนเป็น Audit(ระดับบัณฑิตศึกษา) Request Form for Registration as an Audit </h3>
								</div>
								<div class="card-body">
									...
									<form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12"><strong>มีความประสงค์ขอลงทะเบียนเรียนวิชา เป็น Audit จำนวน /I would like to register as an audit for </strong>
<span class="form-required">*</span> </label>
										...
										<div class="form-group col-sm-12">
											<div class="custom-controls-stacked">
								                ...
								                วิชา รวมหน่วยกิตที่ลงทะเบียนเรียนเป็น Audit/Subject(s) with <input type="text" name="credits " id="credits " class="form-control">
								...
								<!--		<div class="form-group">
                                       ...
                                       <strong> ดังรายวิชาต่อไปนี้ (as follows)</strong>
										...
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">ประธานกรรมการบริหารหลักสูตร/(Chairman of the Curriculum Administration)<span class="form-required">*</span></label>
												<div class="col-sm-9">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">อาจารย์ผู้สอนวิชาเป็น Audit
