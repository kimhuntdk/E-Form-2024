...
/*	$sql_chk = "SELECT rd.doc_type,rd.doc_std_id,rgt.subject_code,rgt.semester,rgt.academic,rgt.advisor_chairman_status FROM request_doc rd left join request_registration_thesis_is rgt on rd.doc_id = rgt.doc_id WHERE rd.doc_std_id=".$_SESSION["SES_STDCODE"];
	...
	if($rs_request_doc){
		...
		$sql_doc = "INSERT INTO request_memorandum_student (doc_id,titlename,name_surname,major,faculty,semester,academic,late_registration,payment_chk,payment_chk_date,evidence_late,photo_1,printed_2,copy_payment_3,copy_id_card_4,copy_house_5,completed_transcript_6,change_name_surname_7,others_8,others_name,submit_document,phone,email,std_signature,std_date_signature) ";
		$sql_doc .= "values($max_id,'$titlename','$name','$major','$faculty','$semester','$academic','$late_registration','$payment_chk','$payment_chk_date','$evidence_late','$photo_1','$printed_2','$copy_payment_3','$copy_id_card_4','$copy_house_5','$completed_transcript_6','$change_name_surname_7','$others_8','$others','$submit_document','$phone','$email','$filename',Now()) ";
	    //echo $sql_doc;
