...
//$doc_id = base64_decode( $_REQUEST[175] ); 
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">คำร้องขอชำระค่าเล่าเรียน/ค่าลงทะเบียน (ระดับบัณฑิตศึกษา) Student Status Tuition Registration Form (Graduate Student) ใช้สำหรับกรณียังไม่ขึ้นสอบจบวิทยานิพนธ์</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <form action="javascipt:;" method="post" id="frm_add_status_retention" class="frm_add_status_retention">
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">ขอชำระค่าธรรมเนียมการศึกษา/ลงทะเบียน/ Would like to retain my studentship in:    <span class="form-required">*</span> </label>
                        </div>
                      </div>
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_status_retention.php", {
						img_data: img_data,
