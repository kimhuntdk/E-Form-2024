            ...
            <div class="card">
                ...
                <form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                    ...
                    <div class="custom-controls-stacked">
                        ...
                        <input type="radio" class="custom-control-input" name="type_thesis" <?php if($row['status_thesis_is']=="Thesis") { echo "checked"; } ?> id="type_thesis" value="Thesis"  <?php if($dean_admin_approve_disapprove !=0) { echo "disabled";} ?> >
                        <span class="custom-control-label">Thesis</span> </label>
                          <label class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" name="type_thesis" <?php if($row['status_thesis_is']=="IS") { echo "checked"; } ?> id="type_thesis" value="IS" <?php if($dean_admin_approve_disapprove !=0) { echo "disabled";}?>>
                    ...
                    <div class="row align-items-right">
                          ...
                          <div class="col-sm-2">
                        <input type="text" class="form-control" placeholder="รหัสวิชา" id="subject_code" name="subject code" value="<?php echo $row['subject_code'];?>" <?php if($dean_admin_approve_disapprove !=0) { echo "disabled";}?>>
                      </div>
...
<div class="form-group">
  ...
  <select class="custom-select" id="dean_admin" name="dean_admin" <?php if($dean_admin_approve_disapprove !=0) { echo "disabled";}?>>
    ...
    <option value="5" <?php if($row[dean_admin] ==5) { echo "selected";}?>>รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ</option>
                    ...
                    <button type="submit" id="btnSaveSign"  class="btn btn-primary btn-space update_btn" <?php if($dean_admin_approve_disapprove !=0) { echo "disabled";}?>>Save Data</button>
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
					...
					$( "#btnSaveSign" ).attr( 'disabled', 'disabled' );
						$.post( "digital-e-signature/update_admin_thesis.php", {
