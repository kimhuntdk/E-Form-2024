						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">ขออนุมัติถอนการลงทะเบียนเรียนเพื่อลาพักการเรียน/Request Form for Leave  of Absence  to  Registratoin</h3>
								</div>
								<div class="card-body">
									...
									<form action="javascipt:;" method="post" id="frm_add_Withdraw_registration_taking_leave" class="frm_add_Withdraw_registration_taking_leave">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12"><strong>มีความประสงค์ขอถอนการลงทะเบียนเพื่อลาพักการเรียน/ Would like cancel to register for to take a leave in :</strong> <span class="form-required">*</span> </label>
											</div>
										</div>
                  ...
                  <span class="custom-control-label">แบบฟอร์ไม่ถูกต้อง</span> </label>
                          ...
                          <option value="5" <?php if($row[dean_admin] ==5) { echo "selected";}?>>รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ</option>
										...
										<div class="btn-list mt-4 text-left">
											...
											<input type="hidden" name="Save_Withdraw_registration_taking_leave" value="Save_Withdraw_registration_taking_leave">
...
<script type="text/javascript">
	$( document ).ready( function () {
		$( "#btnSaveSign" ).click( function () { //ส่งค่าไป Update คำร้อง
			...
			var Save_Withdraw_registration_taking_leave = $( "#Save_Withdraw_registration_taking_leave" ).val();
			...
			if ( staff_grad_approve_disapprove === "1" ) {
				...
				if ( dean_admin === "0" ) {
					...
					$.post(
						"save_staff_withdraw_registration_taking_leave.php",
						$( "#frm_add_Withdraw_registration_taking_leave" ).serializeArray(),
						function ( data ) {
							//alert(data);
							if ( data === "1" ) {
