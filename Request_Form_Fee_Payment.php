	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				var because = $( "input[type=radio][name=Because]:checked" ).val();
				var other = $("#other").val();
				var email = $("#email").val();
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_FeePayment.php", {
							img_data: img_data,
							semester: semester,
							academic: academic,
							because: because,
									...
									<form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12">มีความประสงค์ขอชำระค่าธรรมเนียมการศึกษา (I would like to retain my studentship in) 
                                 		...
                                 		<div class="form-group">
											<div class="row align-items-center">
												...
												<div class="form-group col-sm-9">
											     <div class="custom-controls-stacked">
													<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="Because" id="Because" value="2"><span class="custom-control-label">อื่น ๆ (other) </span><input type="text" class="form-control" name="other" id="other">
                </label>
												</div>
                                                </div>
											</div>
