	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$( "#btnSaveSign" ).click( function ( e ) {
		        ...
		        var status_master_phd = $( "input[type=radio][name=status_master_phd]:checked" ).val();
				var form_program_plan_master = $( "input[type=radio][name=form_program_plan_master]:checked" ).val();
				var to_program_plan_master = $( "input[type=radio][name=to_program_plan_master]:checked" ).val();
				var form_program_plan_phd = $( "input[type=radio][name=form_program_plan_phd]:checked" ).val();
				var to_program_plan_phd = $( "input[type=radio][name=to_program_plan_phd]:checked" ).val();
				var email = $("#email").val();
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_Change_Study_Program.php", {
							img_data: img_data,
							status_master_phd: status_master_phd,
							form_program_plan_master: form_program_plan_master,
							semester: semester,
							academic: academic,
							to_program_plan_master: to_program_plan_master,
							form_program_plan_phd: form_program_plan_phd,
							to_program_plan_phd: to_program_plan_phd,
							advisor: advisor,
							chairman: chairman,
							email:email
...
<span class="form-required">*</span> </label>
                ...
                <input type="radio" id="status_master_phd1" class="custom-control-input" name="status_master_phd" value="1" >
               ...
               <!-- <input type="text" class="form-control" id="finished_assignment" placeholder="" disabled>-->
              	...
              	<div class="form-group col-sm-12">
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="1" >
                <span class="custom-control-label">แผน  ก  แบบ  ก 1/Program A Plan A1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="2">
                <span class="custom-control-label">แผน  ก  แบบ  ก 2 /Program A Plan A2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_master" id="form_program_plan_master" value="3">
                <span class="custom-control-label">แผน  ข/Program B </span> </label>
                                        ...
                                        เป็น/To
											...
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="1" >
                <span class="custom-control-label">แผน  ก  แบบ  ก 1/Program A Plan A1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="2">
                <span class="custom-control-label">แผน  ก  แบบ  ก 2 /Program A Plan A2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_master" id="to_program_plan_master" value="3">
                <span class="custom-control-label">แผน  ข/Program B </span> </label>
												...
												<label class="custom-control custom-radio">
                <input type="radio" id="status_master_phd2" class="custom-control-input" name="status_master_phd" value="2" >
                ...
                <!--<input type="text" class="form-control" placeholder="" id="unstarting_assignment" disabled>-->
               	...
               	<div class="form-group col-sm-12">
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="1" >
                <span class="custom-control-label">แบบ  1.1/Plan 1.1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="2">
                <span class="custom-control-label">แบบ  1.2/Plan 1.2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="3">
                <span class="custom-control-label">แบบ  2.1/Plan 2.1</span> </label>
                	<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="form_program_plan_phd" id="form_program_plan_phd" value="4">
                <span class="custom-control-label">แบบ  2.2/Plan 2.2</span> </label>
                                        ...
                                        เป็น/To
											...
											<div class="custom-controls-stacked">
																<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="1" >
                <span class="custom-control-label">แบบ  1.1/Plan 1.1</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="2">
                <span class="custom-control-label">แบบ  1.2/Plan 1.2</span> </label>
											
												<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="3">
                <span class="custom-control-label">แบบ  2.1/Plan 2.1</span> </label>
                	<label class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" name="to_program_plan_phd" id="to_program_plan_phd" value="4">
                <span class="custom-control-label">แบบ  2.2/Plan 2.2</span> </label>
										...
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">อาจารย์ที่ปรึกษา/ประธานควบคุมวิทยานิพนธ์(Advisor/Chairman of the thesis)<span class="form-required">*</span></label>
												<div class="col-sm-9">
                                        ...
                                        <div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-3">ประธานกรรมการบริหารหลักสูตร
(Chairman of the board of program)
 <span class="form-required">*</span></label>
												<div class="col-sm-9">
													<select id="chairman" name="chairman" class="custom-select">
														<?php
														$sql_chk = " select std_faculty_id FROM  request_student WHERE  std_id_std=" . $_SESSION[ 'SES_STDCODE' ];
														$rs_chk = $mysqli->query( $sql_chk );
														$row_chk = $rs_chk->fetch_array();
