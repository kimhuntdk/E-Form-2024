...
//=========แสดงข้อมูลนิสิตที่ยื่นเอกสาร======================
 $sql = "SELECT * FROM request_doc LEFT JOIN request_proposal_examination ON request_doc.doc_id=request_proposal_examination.doc_id WHERE request_doc.doc_id=" . $doc_id;
$result = $mysqli->query( $sql );
$row = $result->fetch_array();
$advisor_chairman_status = $row[ 'advisor_status' ];
//=========แสดงข้อมูลนิสิต======================
		...
		$( "#btnSaveSign" ).click( function ( e ) {
			...
			html2canvas( [ document.getElementById( 'sign-pad' ) ], {
				onrendered: function ( canvas ) {
					...
					$.post( "digital-e-signature/Advisor_update_Proposal_Examination.php", {
						img_data: img_data,
	...
	<div class="page">
		<div class="page-main">
			...
			<div class="my-3 my-md-5">
					...
					<div class="row row-cards row-deck">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">คำร้องตั้งคณะกรรมการสอบโครงร่างวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ</h3>
								</div>
								<div class="card-body">
									...
									<form action="Javascript:void(0);" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12">มีความประสงค์แต่งตั้งคณะกรรมสอบ</label>
											</div>
										</div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select" id="academic" name="academic" disabled>
                          ...
                          <option value="2554" <?php if($row[ 'academic']=="2554" ) { echo "selected"; } ?>>2554</option>
											...
											<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-2">คณะกรรมการสอบ<span class="form-required">*</span></label>
												<?php
										 ...
										 <div class="form-group">
											<div class="row align-items-center">
												...
												<div class="col-sm-10"> 
													<input type="date" class="form-control" id="date_exam" name="date_exam" value="<?=$row['exam_day'];?>" disabled >
											...
											<div class="row align-items-center">
												...
												<div class="col-sm-10"> 
													<input type="text" class="form-control" id="room_exam" name="room_exam" value="<?=$row['exam_room'];?>" disabled  >
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-10">
                            <label class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input" name="advisor_chairman_status" <?php if($row['advisor_status']=="1") { echo "checked"; } ?> id="advisor_chairman_status" value="1" <?php if($advisor_chairman_status !=0) { echo "disabled";}?>  >
                              <span class="custom-control-label">อนุมัติ</span> </label>
                            <label class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input" name="advisor_chairman_status" <?php if($row['advisor_status']=="2") { echo "checked"; } ?> id="advisor_chairman_status" value="2" <?php if($advisor_chairman_status !=0) { echo "disabled";}?> >
                      ...
                      <div class="form-group">
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-10">
                            <textarea name="argument" id="argument" class="form-control" <?php if($advisor_chairman_status !=0) { echo "disabled";}?>><?php  if(isset($row['advisor_chairman_node'])){  echo $row['advisor_chairman_node'];  } ?></textarea>
                          </div>
                        </div>
                      </div>
                      <?php

										$sql_advisor = "Select prefixname,advisorname,advisorsurname FROM request_advisor WHERE advisorcode=".$_SESSION["SES_USER"];
			  ...
			  ?>
                            <img src="digital-e-signature/doc_signs/<?=$row["advisor_signature"];?>.png">
