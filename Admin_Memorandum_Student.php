		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
					...
					$( "#btnSaveSign" ).attr( 'disabled', 'disabled' );
						$.post( "digital-e-signature/update_admin_memorandum.php", {
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-sm-9"> <img src="digital-e-signature/doc_signs/<?=$row['std_signature'];?>.png"> <?php echo $row['titlename'];?>&nbsp;<?php echo $row['name_surname'];?> </div>
            </div>
          </div>
