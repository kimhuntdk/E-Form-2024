...
$sql_aa = "SELECT * FROM request_doc INNER JOIN request_proposal_examination ON request_doc.doc_id=request_proposal_examination.doc_id INNER JOIN request_student ON request_proposal_examination.std_code=request_student.std_id_std WHERE request_proposal_examination.doc_id=" . $doc_id;
...
src="images/image004.png"><![endif]><o:p></o:p></span></p>
...
<h3><span lang=TH style='font-size:14.0pt;font-family:"TH SarabunPSK","sans-serif"'>แบบขออนุมัติสอบเค้าโครงวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ
<br>
และแต่งตั้งคณะกรรมการสอบเค้าโครงวิทยานิพนธ์</span><span style='font-size:14.0pt;
...
และแต่งตั้งคณะกรรมการสอบเค้าโครงวิทยานิพนธ์</span><span style='font-family:
...
lang=TH style='font-family:"TH SarabunPSK","sans-serif"'>รายชื่อคณะกรรมการสอบเค้าโครงวิทยานิพนธ์</span></b><span
