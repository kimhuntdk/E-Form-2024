                    ...
                    <form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">มีความประสงค์คำร้องชำระค่าธรรมเนียมการศึกษา /Request Form for Fee Payment in <span class="form-required">*</span> </label>
                        </div>
                      </div>
...
$(document).ready(function(e){
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
						...
						$.post( "digital-e-signature/update_admin_fee_payment.php", {
