	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$( "#btnSaveSign" ).click( function ( e ) {
			    ...
			    var node = $("#node").val();
				var advisor_chairman_dean_status = $( "input[type=radio][name=advisor_chairman_dean_status]:checked" ).val();
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_Document_Student.php", {
							img_data: img_data,
							government:government,
							subject:subject,
							node: node,	
							advisor_chairman_dean_status:advisor_chairman_dean_status,
							advisor: advisor,
							email:email
