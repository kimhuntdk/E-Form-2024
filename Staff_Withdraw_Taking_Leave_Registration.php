						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน/Request Form for Leave  of Absence  to  Registratoin</h3>
								</div>
								<div class="card-body">
									...
									<form action="javascipt:;" method="post" id="frm_add_Withdraw_taking_leave_registratione" class="frm_add_Withdraw_taking_leave_registratione">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12"><strong>มีความประสงค์ขออนุมัติถอนการลาพักการเรียนเพื่อลงทะเบียน/ Would like cancel to register for to take a leave in :</strong> <span class="form-required">*</span> </label>
											</div>
										</div>
                  ...
                  <span class="custom-control-label">แบบฟอร์ไม่ถูกต้อง</span> </label>
                          ...
                          <option value="5" <?php if($row[dean_admin] ==5) { echo "selected";}?>>รองคณบดีบัณฑิตวิทยาลัยฝ่ายประกันคุณภาพการศึกษาและกิจการพิเศษ</option>
										...
										<div class="btn-list mt-4 text-left">
											...
											<input type="hidden" name="Save_Staff_withdraw_taking_leave_registration" value="Save_Staff_withdraw_taking_leave_registration">
...
<script type="text/javascript">
	$( document ).ready( function () {
		$( "#btnSaveSign" ).click( function () { //ส่งค่าไป Update คำร้อง
			...
			var Save_Staff_withdraw_taking_leave_registration = $( "#Save_Staff_withdraw_taking_leave_registration" ).val();
			var argument_a = $( "#argument_a" ).val();
            if(staff_grad_approve_disapprove== undefined){
				alert( "กรุณาพิจารณาเรื่อง" );
			    $("#staff_grad_approve_disapprove").focus();
			...
			if ( staff_grad_approve_disapprove === "1" ) {
				...
				if ( dean_admin === "0" ) {
					...
					$.post(
						"save_staff_withdraw_taking_leave_registration.php",
						$( "#frm_add_Withdraw_taking_leave_registratione" ).serializeArray(),
						function ( data ) {
							//alert(data);
							if ( data === "1" ) {
								...
								alert( "ไม่สามารถทำรายการได้กรุณาทำรายการอีกครั้ง2" );
								window.location.href = 'staff.php';
