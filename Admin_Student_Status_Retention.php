                    ...
                    <form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
                      <div class="form-group">
                        <div class="row align-items-center">
                          <label class="col-sm-12">มีความประสงค์<span class="card-title">ขอชำระค่าธรรมเนียมการศึกษา/ลงทะเบียน/ </span>/ Would like to <span class="card-title">retain my studentship in </span> in <span class="form-required">*</span></label>
                        </div>
                      </div>
...
$(document).ready(function(e){
		...
		$("#btnSaveSign").click(function(e){
			...
			/*		$.ajax({
						...
						$.post( "digital-e-signature/update_admin_status_retention.php", {
