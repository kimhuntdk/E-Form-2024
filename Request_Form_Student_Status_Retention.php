			...
			$( "#btnSaveSign" ).click( function ( e ) {
				...
				html2canvas( [ document.getElementById( 'sign-pad' ) ], {
					onrendered: function ( canvas ) {
						...
						$.post( "digital-e-signature/Save_StudentStatusRetention.php", {
							img_data: img_data,
							semester: semester,
							academic: academic,
							because: because,
									...
									<form action="javascipt:;" method="post" id="frm_add_thesis_is" class="frm_add_thesis_is">
										<div class="form-group">
											<div class="row align-items-center">
												<label class="col-sm-12">มีความประสงค์ขอชำระค่าธรรมเนียมการศึกษา/ลงทะเบียน/ Would like to retain my studentship in <span class="form-required">*</span> </label>
											</div>
										</div>
