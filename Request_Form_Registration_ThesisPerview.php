...
$doc_id_ = base64_decode($_REQUEST[doc_id]);
...
//header("Content-Disposition: attachment; filename=Blue-Screen.pdf");
		...
		//date_default_timezone_set("Asia/Bangkok");
		 ...
		 $q="
			SELECT request_registration_thesis_is.doc_id , semester , academic , because , std_signature , std_date_signature , status_thesis_is , 
			subject_code , credits , advisor_chairman , advisor_chairman_status , advisor_chairman_signature,
			argument , advisor_chairman_date , staff_grad_node , staff_grad_approve_disapprove , dean_admin , dean_admin_approve_disapprove,
			dean_admin_node , dean_admin_date , doc_std_id , doc_date 
			FROM request_registration_thesis_is , request_doc WHERE request_doc.doc_id = request_registration_thesis_is.doc_id and  	registration_thesis_is_id = $doc_id_  ";
			 ...
			 $rs = $result->fetch_array();
				...
				$status_thesis_is=$rs['status_thesis_is'];
...
<![endif]-->
<title>คำร้องขอลงทะเบียน Thesis/IS</title>
<!--[if gte mso 9]><xml>
 ...
 <tr>
  ...
  <table cellpadding=0 cellspacing=0 width="100%">
   <tr>
    ...
    14</span><span style='font-size:16.0pt;font-family:"TH SarabunPSK",sans-serif'><o:p></o:p></span></p>
...
style='mso-spacerun:yes'>&nbsp;</span>คำร้องขอลงทะเบียน Thesis/IS </span><span
...
style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span><span style='font-family:"TH SarabunPSK",sans-serif;font-weight:
normal'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Form for Registration for Thesis/IS (Graduate Student)<span
style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span><span
...
style='font-family:"TH SarabunPSK",sans-serif'>มีความประสงค์ขอลงทะเบียน/ </span></b><span
style='font-family:"TH SarabunPSK",sans-serif'>would like to register  :<span
style='mso-spacerun:yes'> 
  <?php if($status_thesis_is=='Thesis'){ echo "<input type='checkbox' checked>" ;} else { echo "<input type='checkbox'>" ; } ; ?>
  &nbsp;Thesis  
  <?php if($status_thesis_is=='IS'){ echo "<input type='checkbox' checked>" ;} else { echo "<input type='checkbox'>" ; } ; ?>
  IS    &nbsp; </span>
    <o:p></o:p></span></p>
<p class=MsoNormal><span style='font-family:"TH SarabunPSK",sans-serif'><b>รหัสวิชา</b>/ subject code ...........<?php echo $subject_code ; ?>..............<b>เพิ่มอีก</b> (more)
  .............<?php echo $credits ; ?>............<b>หน่วยกิต</b> (credits)
  <o:p></o:p></span></p>
...
<img src="digital-e-signature/doc_signs/<?=$std_signature.".png";?>" width="150"><b><span lang=TH>ผู้ยื่นคำร้อง</span></b>/ 
Applicant
<o:p></o:p></span></p>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  style='font-family:"TH SarabunPSK",sans-serif'>/ Signature <img src="digital-e-signature/doc_signs/<?=$advisor_chairman_signature.".png";?>" width="150"></span></p>
  <p class=MsoNormal style='text-align:justify;tab-stops:0.7cm'><span
  style='font-family:"TH SarabunPSK",sans-serif'><span
  style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
