...
header("Content-Disposition: attachment; filename=certificate-topic.doc");
require_once( "inc/db_connect.php" );
$mysqli = connect();

//== 
 $doc_id = base64_decode( $_REQUEST[ id ] );
  $sql_aa = "SELECT * FROM request_doc INNER JOIN request_certificate_topic_thesis ON request_doc.doc_id=request_certificate_topic_thesis.doc_id WHERE request_certificate_topic_thesis.doc_id=" . $doc_id;
...
<link rel=File-List href="docx_export_files/filelist.xml">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2021-04-01T02:52:00Z</o:Created>
  <o:LastSaved>2021-04-01T02:52:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>176</o:Words>
  <o:Characters>1006</o:Characters>
...
<link rel=themeData href="docx_export_files/themedata.thmx">
<link rel=colorSchemeMapping href="docx_export_files/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
color:black'>หนังสือรับรองการอนุมัติหัวข้อและโครงร่างวิทยานิพนธ์</span></b><b><span
...
<p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
text-align:center;line-height:normal'><span style='font-size:8.0pt;font-family:
...
1'>&nbsp;&nbsp;&nbsp; </span>รับรองการอนุมัติหัวข้อและโครงร่างวิทยานิพนธ์</span><span
style='font-size:16.0pt;font-family:"TH SarabunPSK",sans-serif;mso-fareast-font-family:
"Cordia New";color:black'><o:p></o:p></span></p>
...
36.0pt;line-height:115%'><span lang=TH style='font-size:16.0pt;line-height:
115%;font-family:"TH SarabunPSK",sans-serif;mso-fareast-font-family:"Cordia New";
color:black'>ตามที่สำนักงานการวิจัยแห่งชาติ (วช.)/สำนักงานพัฒนาวิทยาศาสตร์และเทคโนโลยี
(สวทช.) ได้ประกาศรับข้อเสนอทุนพัฒนาบัณฑิตศึกษาประจำปี 2564 นั้น มหาวิทยาลัยมหาสารคาม
ขอแจ้งว่า<span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black"><?php echo $row_name['std_fname_th'];?>&nbsp;<?php echo $row_name['std_lname_th'];?></span> รหัสประจำตัว<span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black">
<?=$row_name['std_id_std'];?>
</span>เป็นนิสิตระดับบัณฑิตศึกษา
ระดับ<span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black">
<?=$row_name['std_degree_th'];?>
</span>สาขา<span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black">
<?=$row_name['std_major_th'];?>
</span><span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black">
<?=$row_name['std_faculty_th'];?>
</span> ได้รับการอนุมัติหัวข้อและโครงร่างวิทยานิพนธ์ เรื่อง </span><span style="font-size:16.0pt;line-height:115%;font-family:&quot;TH SarabunPSK&quot;,sans-serif;
mso-fareast-font-family:&quot;Cordia New&quot;;color:black">
<?=$row_aa['subject'];?>
</span><span
lang=TH style='font-size:16.0pt;line-height:115%;font-family:"TH SarabunPSK",sans-serif;
mso-fareast-font-family:"Cordia New";color:black'> ซึ่งคณะกรรมการบัณฑิตศึกษาประจำ
<?=$row_name['std_faculty_th'];?>
ได้อนุมัติให้นิสิตดังกล่าวจัดทำวิทยานิพนธ์ได้ต่อไป
<o:p></o:p></span></p>

<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:
justify;text-justify:inter-cluster;line-height:115%'><span style='font-size:
8.0pt;line-height:115%;font-family:"TH SarabunPSK",sans-serif;mso-fareast-font-family:
"Cordia New";color:black'><o:p>&nbsp;</o:p></span></p>
...
style='font-size:16.0pt;line-height:115%;font-family:"TH SarabunPSK",sans-serif;
mso-fareast-font-family:"Cordia New";color:black'><span style='mso-tab-count:
2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>จึงเรียนมาเพื่อโปรดทราบ
</span><span style='font-size:16.0pt;line-height:115%;font-family:"TH SarabunPSK",sans-serif;
mso-fareast-font-family:"Cordia New";color:black'><o:p></o:p></span></p>
...
<p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
normal'><span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK",sans-serif;
mso-fareast-font-family:"Cordia New";color:black'>043 754 412</span><span
style='font-size:16.0pt;font-family:"TH SarabunPSK",sans-serif;mso-fareast-font-family:
"Cordia New";color:black'><o:p></o:p></span></p>
